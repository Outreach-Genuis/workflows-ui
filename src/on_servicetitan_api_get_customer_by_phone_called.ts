...
const node = {"name":"On Get Customer by Phone Called","id":"on_servicetitan_api_get_customer_by_phone_called","descripition":"Triggers when Get Customer by Phone is called via MCP API (ServiceTitan API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_servicetitan_api_get_customer_by_phone_called" };
