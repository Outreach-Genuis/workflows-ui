...
const node = {"name":"On Get Job Types Called","id":"on_servicetitan_api_get_job_types_called","descripition":"Triggers when Get Job Types is called via MCP API (ServiceTitan API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_servicetitan_api_get_job_types_called" };
