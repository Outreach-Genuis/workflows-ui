...
const node = {"name":"On Get Business Units Called","id":"on_servicetitan_api_get_business_units_called","descripition":"Triggers when Get Business Units is called via MCP API (ServiceTitan API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_servicetitan_api_get_business_units_called" };
