...
const node = {"name":"Get Geo Address","id":"servicetitan_api_get_geo_address","descripition":"Geocodes an address using Google Maps Geocoding API. Takes a street address or ZIP code and returns geocoded address suggestions. Uses optional city, state, and country MCP properties to streamline search when provided.","inputSchema": {
  ...
  },"groups":["ServiceTitan API","Get Geo Address"],"branches":{"success":{"id":"success","name":"Success","description":"Successful execution"}},"isTriggerNode":false,"cost":0} as Node;

export { node as "servicetitan_api_get_geo_address" };
