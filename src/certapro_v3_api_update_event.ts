...
const node = {"name":"Update Event","id":"certapro_v3_api_update_event","descripition":"Books/updates a calendar event with customer information. Takes an event_uid from the available slots and updates it with customer details.","inputSchema": {
    notes: {
      name: "notes",
  ...
  },"groups":["CertaPro V3 API","Update Event"],"branches":{"success":{"id":"success","name":"Success","description":"Successful execution"}},"isTriggerNode":false,"cost":0} as Node;

export { node as "certapro_v3_api_update_event" };
