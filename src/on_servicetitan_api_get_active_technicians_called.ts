...
const node = {"name":"On Get Active Technicians Called","id":"on_servicetitan_api_get_active_technicians_called","descripition":"Triggers when Get Active Technicians is called via MCP API (ServiceTitan API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_servicetitan_api_get_active_technicians_called" };
