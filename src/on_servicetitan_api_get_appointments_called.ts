...
const node = {"name":"On Get Appointments Called","id":"on_servicetitan_api_get_appointments_called","descripition":"Triggers when Get Appointments is called via MCP API (ServiceTitan API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_servicetitan_api_get_appointments_called" };
