...
const node = {"name":"On Update Location Contact Called","id":"on_servicetitan_api_update_location_contact_called","descripition":"Triggers when Update Location Contact is called via MCP API (ServiceTitan API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_servicetitan_api_update_location_contact_called" };
