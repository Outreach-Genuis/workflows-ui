...
const node = {"name":"On Get Job Called","id":"on_psa_api_get_job_called","descripition":"Triggers when Get Job is called via MCP API (PSA API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_psa_api_get_job_called" };
