...
const node = {"name":"On Update Event Called","id":"on_certapro_v2_api_update_event_called","descripition":"Triggers when Update Event is called via MCP API (CertaPro V2 API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_certapro_v2_api_update_event_called" };
