...
const node = {"name":"Process Chat Response","id":"get_chat_response","descripition":"Processes a chat message and sends a reply from the assigned agent using the specified communication channel.","inputSchema": {
    sessionType: {
      name: "Session Type",
