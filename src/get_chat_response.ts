...
const node = {"name":"Process Chat Response (Deprecated)","id":"get_chat_response","descripition":"Processes a chat message and sends a reply from the assigned agent using the specified communication channel.","inputSchema": {
    sessionType: {
      name: "Session Type",
    ...
    extraInstructions: {
      ...
      validationSchema: /.*/,
      errorMessage:
        "Extra instructions must be less than 1000 characters if provided",
      required: false,
      input: {
        type: "textarea",
