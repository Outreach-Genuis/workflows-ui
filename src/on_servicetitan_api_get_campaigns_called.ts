...
const node = {"name":"On Get Campaigns Called","id":"on_servicetitan_api_get_campaigns_called","descripition":"Triggers when Get Campaigns is called via MCP API (ServiceTitan API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_servicetitan_api_get_campaigns_called" };
