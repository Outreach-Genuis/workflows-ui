...
const node = {"name":"Get Agent Chat History (Deprecated)","id":"get_agent_chat_history","descripition":"Retrieves the chat history for a specific agent and communication channel.","inputSchema": {
    sessionType: {
      name: "Session Type",
