...
const node = {"name":"On Update Event Called","id":"on_certapro_api_update_event_called","descripition":"Triggers when Update Event is called via MCP API (CertaPro API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
  ...
  },"groups":["CertaPro API","Triggers","MCP"],"branches":{"success":{"id":"success","name":"Success","description":"Tool call completed successfully"},"failure":{"id":"failure","name":"Failure","description":"Tool call failed with an error"}},"isTriggerNode":true,"cost":0} as Node;

export { node as "on_certapro_api_update_event_called" };
