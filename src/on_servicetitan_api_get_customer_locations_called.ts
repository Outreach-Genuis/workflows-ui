...
const node = {"name":"On Get Customer Locations Called","id":"on_servicetitan_api_get_customer_locations_called","descripition":"Triggers when Get Customer Locations is called via MCP API (ServiceTitan API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_servicetitan_api_get_customer_locations_called" };
