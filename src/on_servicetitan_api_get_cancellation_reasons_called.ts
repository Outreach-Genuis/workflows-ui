...
const node = {"name":"On Get Cancellation Reasons Called","id":"on_servicetitan_api_get_cancellation_reasons_called","descripition":"Triggers when Get Cancellation Reasons is called via MCP API (ServiceTitan API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_servicetitan_api_get_cancellation_reasons_called" };
