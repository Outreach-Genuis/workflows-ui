...
const node = {"name":"List Available Estimate Slots","id":"housecall_v1_api_list_available_estimate_slots","descripition":"Return available 2-hour EST blocks (10,12,14,16) for the given date with bookable employees.","inputSchema": {
    date: {
      name: "date",
