...
const node = {"name":"Make Call (Deprecated)","id":"make_call","descripition":"Places an outbound phone call to the specified number with customizable script and voice options","inputSchema": {
    phone: {
      name: "Phone Number",
      description:
    ...
    callAnyTime: {
      name: "Call Any Time",
      description:
        "Allow this call to be placed at any time, ignoring calling-hours restrictions",
    ...
    hangupReason: {
      ...
      required: false,
      validator: (
        reason: "user_hangup" | "ai_hangup" | "silence_timeout" | "other",
      ) =>
        ["user_hangup", "ai_hangup", "silence_timeout", "other"].includes(
          reason,
        ),
    },
