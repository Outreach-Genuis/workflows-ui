...
const node = {"name":"Process Variable","id":"process_variable","descripition":"Processes a variable with various string, number, and JSON operations","inputSchema": {
    ...
    useRegex: {
      ...
      parse: function (value: string): boolean {
        return value === "true" || (value as any) === true;
      },
    },
    regexFlags: {
      name: "Regex Flags",
  ...
  },"groups":["system","Data Processing","Utilities"],"branches":{"success":{"id":"success","name":"Success","description":"Successful execution"},"error":{"id":"error","name":"Error","description":"An error occurred during execution"}},"isTriggerNode":false,"cost":0} as Node;
