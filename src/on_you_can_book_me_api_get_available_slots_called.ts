...
const node = {"name":"On Get Available Slots Called","id":"on_you_can_book_me_api_get_available_slots_called","descripition":"Triggers when Get Available Slots is called via MCP API (You Can Book Me API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_you_can_book_me_api_get_available_slots_called" };
