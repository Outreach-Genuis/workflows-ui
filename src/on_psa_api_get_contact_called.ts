...
const node = {"name":"On Get Contact Called","id":"on_psa_api_get_contact_called","descripition":"Triggers when Get Contact is called via MCP API (PSA API)","inputSchema": {},"outputSchema": {
    callerPhone: {
      name: "Caller Phone",
...
export { node as "on_psa_api_get_contact_called" };
