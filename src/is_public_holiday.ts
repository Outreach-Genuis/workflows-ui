...
const node = {"name":"Is Public Holiday","id":"is_public_holiday","descripition":"Check if current date is a public holiday in the US","inputSchema": {
  ...
  },"groups":["system"],"branches":{"match":{"name":"Match","description":"Condition matched","id":"match"},"no_match":{"name":"No Match","description":"Condition did not match","id":"no_match"}},"isTriggerNode":false,"cost":0} as Node;
