...
declare const nodes: {
    ...
    youcanbookme_api_get_available_slots: Node;
    on_youcanbookme_api_get_available_slots_called: Node;
    youcanbookme_api_book_slot: Node;
    on_youcanbookme_api_book_slot_called: Node;
    ...
    check_job_status_service_titan: Node;
