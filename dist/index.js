...
var node15 = { "name": "Get Agent Chat History", "id": "get_agent_chat_history", "descripition": "Retrieves the chat history for a specific agent and communication channel.", "inputSchema": {
  sessionType: {
    name: "Session Type",
...
var node16 = { "name": "Process Chat Response", "id": "get_chat_response", "descripition": "Processes a chat message and sends a reply from the assigned agent using the specified communication channel.", "inputSchema": {
  sessionType: {
    name: "Session Type",
    description: "Type of the chat session",
    validationSchema: /^(sms|email|whatsapp|messenger)$/,
...
// src/get_constant.ts
var node17 = { "name": "Get Constant", "id": "get_constant", "descripition": "Returns various useful constants like time information, system values, and random data", "inputSchema": {
  constantType: {
    name: "Constant Type",
...
var node18 = { "name": "Get Lead Service Titan", "id": "get_lead_service_titan", "descripition": "Get details of a specific lead from ServiceTitan", "inputSchema": {
  customerId: {
    name: "Customer ID",
...
var node19 = { "name": "Get Live Staging Leads", "id": "get_live_staging_leads", "descripition": "A description for GetLiveStagingLeads", "inputSchema": {
  type: {
    name: "Lead Type",
...
var node20 = { "name": "Get SMS Campaign Messages", "id": "get_s_m_s_campaign_messages", "descripition": "Retrieves all messages from a specific SMS campaign by campaign ID", "inputSchema": {
  phone: {
    name: "Phone Number",
...
var node21 = { "name": "Get Service Titan Recurring Service Estimates", "id": "get_service_titan_recurring_service_estimates", "descripition": "A description for GetServiceTitanRecurringServiceEstimates", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_service_titan_accounts_receievables.ts
var node22 = { "name": "Get Service Titan Unpaid Invoices", "id": "get_service_titan_accounts_receievables", "descripition": "Retrieves unpaid invoices from ServiceTitan that are past a specified number of days due.", "inputSchema": {
  daysPastDue: {
    name: "Days Past Due",
...
// src/get_tags.ts
var node23 = { "name": "Get Tags", "id": "get_tags", "descripition": "Retrieves all tags associated with a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
var node24 = { "name": "Get Unassigned Recurring Events", "id": "get_unassigned_recurring_events", "descripition": "A description for GetUnassignedRecurringServiceEvents", "inputSchema": {
  nextNDays: {
    name: "Next N Days",
...
var node25 = { "name": "Get Uploaded Leads Trigger", "id": "get_uploaded_leads_trigger", "descripition": "Triggers a workflow when new leads are uploaded, with options for scheduling and limiting the number of leads", "inputSchema": {
  numLeadsToFetch: {
...
// src/get_variable.ts
var node26 = { "name": "Get Variable", "id": "get_variable", "descripition": "Gets the value of a stored variable", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
...
var node27 = { "name": "Book Estimate", "id": "housecall_v1_api_book_estimate", "descripition": "Create and schedule an estimate with required last name, free estimate line item, bookable employees, and call summary note.", "inputSchema": {
  callSummary: {
    name: "call_summary",
...
var node28 = { "name": "Find Or Create Customer", "id": "housecall_v1_api_find_or_create_customer", "descripition": "Lookup by phone and create if not found (returns the single customer record).", "inputSchema": {
  lastName: {
    name: "last_name",
...
var node29 = { "name": "Get Customer", "id": "housecall_v1_api_get_customer", "descripition": "Retrieve a customer by ID from Housecall.", "inputSchema": {
  id: {
    name: "id",
...
var node30 = { "name": "List Available Estimate Slots", "id": "housecall_v1_api_list_available_estimate_slots", "descripition": "Return available 2-hour EST blocks (10,12,14,16) for the given date with bookable employees.", "inputSchema": {
  date: {
    name: "date",
...
var node31 = { "name": "Search Customers By Phone", "id": "housecall_v1_api_search_customers_by_phone", "descripition": "Find existing customers using a phone number provided during the call.", "inputSchema": {
  phone: {
    name: "phone",
...
var node32 = { "name": "Book Meeting", "id": "hubspot_crm_api_book_meeting", "descripition": "Book a meeting using a scheduling page.", "inputSchema": {
  locale: {
    name: "locale",
...
var node33 = { "name": "Book Meeting Slot", "id": "hubspot_crm_api_book_meeting_slot", "descripition": "Book a meeting using a time slot ID from the availability results.", "inputSchema": {
  locale: {
    name: "locale",
    description: "Locale (e.g., 'en-us')",
    required: false,
...
var node34 = { "name": "Create CRM Meeting", "id": "hubspot_crm_api_create_crm_meeting", "descripition": "Create a meeting engagement in HubSpot CRM (not for scheduling).", "inputSchema": {
  contactIds: {
    name: "contactIds",
...
var node35 = { "name": "Create Contact", "id": "hubspot_crm_api_create_contact", "descripition": "Create a new contact in HubSpot CRM with contact information.", "inputSchema": {
  jobtitle: {
    name: "jobtitle",
...
var node36 = { "name": "Create Meeting", "id": "hubspot_crm_api_create_meeting", "descripition": "Create a new meeting/appointment in HubSpot.", "inputSchema": {
  contactIds: {
    name: "contactIds",
...
var node37 = { "name": "Create Note", "id": "hubspot_crm_api_create_note", "descripition": "Create a note in HubSpot and associate it with contacts.", "inputSchema": {
  contactIds: {
    name: "contactIds",
...
var node38 = { "name": "Get Available Time Slots", "id": "hubspot_crm_api_get_available_time_slots", "descripition": "Get human-readable available time slots for booking meetings.", "inputSchema": {
  days: {
    name: "days",
...
var node39 = { "name": "Get CRM Meeting", "id": "hubspot_crm_api_get_crm_meeting", "descripition": "Retrieve a CRM meeting engagement by ID.", "inputSchema": {
  meetingId: {
    name: "meetingId",
...
var node40 = { "name": "Get Contact", "id": "hubspot_crm_api_get_contact", "descripition": "Retrieve a contact by ID or email from HubSpot.", "inputSchema": {
  email: {
    name: "email",
    description: "Contact's email address",
    required: false,
...
var node41 = { "name": "Get Meeting", "id": "hubspot_crm_api_get_meeting", "descripition": "Retrieve a meeting by ID from HubSpot.", "inputSchema": {
  meetingId: {
    name: "meetingId",
    description: "HubSpot meeting ID",
    required: true,
...
var node42 = { "name": "Get Meeting Availability", "id": "hubspot_crm_api_get_meeting_availability", "descripition": "Get availability page for a meeting link.", "inputSchema": {
  timezone: {
    name: "timezone",
    description: "Timezone",
    required: true,
...
var node43 = { "name": "Get Meeting Booking Info", "id": "hubspot_crm_api_get_meeting_booking_info", "descripition": "Get booking information and availability for a meeting link.", "inputSchema": {
  monthOffset: {
    name: "monthOffset",
...
var node44 = { "name": "Search CRM Meetings", "id": "hubspot_crm_api_search_crm_meetings", "descripition": "Search for CRM meeting engagements by criteria.", "inputSchema": {
  limit: {
    name: "limit",
...
var node45 = { "name": "Search Contacts", "id": "hubspot_crm_api_search_contacts", "descripition": "Search for contacts in HubSpot using various criteria.", "inputSchema": {
  limit: {
    name: "limit",
    description: "Maximum number of results",
    required: false,
...
var node46 = { "name": "Search Meetings", "id": "hubspot_crm_api_search_meetings", "descripition": "Search for meetings in HubSpot by various criteria.", "inputSchema": {
  limit: {
    name: "limit",
    description: "Maximum number of results",
    required: false,
...
var node47 = { "name": "Test Connection", "id": "hubspot_crm_api_test_connection", "descripition": "Test the HubSpot API connection and authentication.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node48 = { "name": "Update CRM Meeting", "id": "hubspot_crm_api_update_crm_meeting", "descripition": "Update an existing CRM meeting engagement.", "inputSchema": {
  location: {
    name: "location",
    description: "Meeting location",
    required: false,
...
var node49 = { "name": "Update Meeting", "id": "hubspot_crm_api_update_meeting", "descripition": "Update an existing meeting in HubSpot.", "inputSchema": {
  location: {
    name: "location",
    description: "Meeting location",
    required: false,
...
var node50 = { "name": "Inbound Call Trigger", "id": "inbound_call_trigger", "descripition": "Triggers a workflow when an inbound call is received, providing caller details and call transcription", "inputSchema": {}, "outputSchema": {
  phone: {
    name: "Phone Number",
...
var node51 = { "name": "Is Public Holiday", "id": "is_public_holiday", "descripition": "Check if current date is a public holiday in the US", "inputSchema": {
  holidays: {
    name: "Holidays",
...
// src/make_call.ts
var node52 = { "name": "Make Call", "id": "make_call", "descripition": "Places an outbound phone call to the specified number with customizable script and voice options", "inputSchema": {
  phone: {
    name: "Phone Number",
...
var node53 = { "name": "Manual Trigger", "id": "manual_trigger", "descripition": "A description for ManualTrigger", "inputSchema": {}, "outputSchema": {
  phone: {
    name: "Phone Number",
...
var node55 = { "name": "ServiceTitan New Appoinment", "id": "on_new_appoinment_service_titan", "descripition": "Triggers when a new appointment is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node56 = { "name": "ServiceTitan New Call", "id": "on_new_call_service_titan", "descripition": "Triggers when a new call is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  createdOn: {
    name: "Created On",
...
var node57 = { "name": "ServiceTitan New Customer", "id": "on_new_customer_service_titan", "descripition": "Triggers when a new customer is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The unique identifier for the customer",
    example: 12345,
...
var node58 = { "name": "ServiceTitan New Estimate", "id": "on_new_estimate_service_titan", "descripition": "Triggers when a new estimate is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node59 = { "name": "ServiceTitan New Invoice", "id": "on_new_invoice_service_titan", "descripition": "Triggers when a new invoice is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node60 = { "name": "ServiceTitan New Job Or Project Note", "id": "on_new_job_or_project_note_service_titan", "descripition": "Triggers when a new note is added to a job or project in ServiceTitan", "inputSchema": {
  entityType: {
    name: "Note Type",
...
var node61 = { "name": "ServiceTitan New Job", "id": "on_new_job_service_titan", "descripition": "Triggers when a new job is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node62 = { "name": "ServiceTitan New Lead Note", "id": "on_new_lead_note_service_titan", "descripition": "Triggers when a new note is added to a lead in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node63 = { "name": "ServiceTitan New Lead", "id": "on_new_lead_service_titan", "descripition": "Triggers when a new lead is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The ID of the lead",
    example: 123,
...
var node64 = { "name": "ServiceTitan New Payment", "id": "on_new_payment_service_titan", "descripition": "Triggers when a new payment is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node65 = { "name": "ServiceTitan New Project", "id": "on_new_project_service_titan", "descripition": "Triggers when a new project is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node66 = { "name": "On SMS Received", "id": "on_s_m_s_received", "descripition": "A description for OnSMSReceived", "inputSchema": {}, "outputSchema": {
  customerNumber: {
...
// src/on_tag_added.ts
var node67 = { "name": "On Tag Added", "id": "on_tag_added", "descripition": "Triggers a workflow when a tag is added to a lead, providing lead information", "inputSchema": {}, "outputSchema": {
  tag: {
    name: "Tag",
...
var node68 = { "name": "ServiceTitan Updated Call", "id": "on_updated_call_service_titan", "descripition": "Triggers when a call is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_updated_estimate_service_titan.ts
var node69 = { "name": "ServiceTitan Updated Estimate", "id": "on_updated_estimate_service_titan", "descripition": "Triggers when an estimate is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_website_vistor_indentified.ts
var node70 = { "name": "On Website Visitor Identified", "id": "on_website_vistor_indentified", "descripition": "Triggers when an anonymous Website visitor is identified via our Pixel Tag", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
...
var node71 = { "name": "Book Slot", "id": "outreachgenius_calendar_book_slot", "descripition": "Book a Cronofy calendar slot for an event", "inputSchema": {
  timezone: {
    name: "timezone",
    description: "Timezone",
    required: false,
...
var node72 = { "name": "Get Available Slots", "id": "outreachgenius_calendar_get_available_slots", "descripition": "Return available Cronofy slots for an eventId (mapped via project/zip if provided)", "inputSchema": {
  timezone: {
    name: "timezone",
    description: "Timezone",
    required: false,
...
var node73 = { "name": "Add Company", "id": "psa_api_add_company", "descripition": "Create a new company in PSA system with primary site and optional contact info.", "inputSchema": {
  phone: {
    name: "phone",
    description: "Phone number",
    required: false,
...
var node74 = { "name": "Add Contact", "id": "psa_api_add_contact", "descripition": "Create a new contact in PSA system associated with the configured company.", "inputSchema": {
  phone: {
    name: "phone",
...
var node75 = { "name": "Add Job", "id": "psa_api_add_job", "descripition": "Create a new job in PSA system. Only name is required.", "inputSchema": {
  siteName: {
    name: "siteName",
    description: "Site name",
    required: false,
...
var node76 = { "name": "Get Company", "id": "psa_api_get_company", "descripition": "Retrieve company details by ID from PSA system.", "inputSchema": {
  companyId: {
    name: "companyId",
...
var node77 = { "name": "Get Contact", "id": "psa_api_get_contact", "descripition": "Retrieve contact details by ID from PSA system.", "inputSchema": {
  contactId: {
    name: "contactId",
...
var node78 = { "name": "Get Job", "id": "psa_api_get_job", "descripition": "Retrieve job details by ID from PSA system.", "inputSchema": {
  jobId: {
    name: "jobId",
...
var node79 = { "name": "Process Variable", "id": "process_variable", "descripition": "Processes a variable with various string, number, and JSON operations", "inputSchema": {
  value: {
    name: "Value",
...
var node81 = { "name": "Remove Tag From Lead", "id": "remove_tag_from_lead", "descripition": "Removes a specified tag from a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
// src/repeat_job.ts
var node82 = { "name": "Repeat Job", "id": "repeat_job", "descripition": "A description for RepeatJob", "inputSchema": {
  repeatType: {
    name: "Repeat Type",
...
var node83 = { "name": "Run Another Workflow", "id": "run_another_workflow", "descripition": "A description for RunAnotherWorkflow", "inputSchema": {
  workflowCode: {
    name: "Workflow Code",
...
var node84 = { "name": "Run Once", "id": "run_once_trigger", "descripition": "A trigger node that runs only once when the workflow is activated", "inputSchema": {}, "outputSchema": {}, "groups": ["Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/sample_api_counter_tool.ts
var node85 = { "name": "Counter Tool", "id": "sample_api_counter_tool", "descripition": "This tool increments a counter stored in the session.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node86 = { "name": "Sample Tool", "id": "sample_api_sample_tool", "descripition": "This is a sample tool within the Sample API.", "inputSchema": {
  param1: {
    name: "param1",
...
var node87 = { "name": "Send Direct Mail", "id": "send_direct_mail", "descripition": "Sends a physical direct mail using a service provider", "inputSchema": {
  productId: {
    name: "Product ID",
...
var node88 = { "name": "Send Email Notification", "id": "send_email_notification", "descripition": "Sends an email message with customizable from, to, cc, bcc fields and SMTP configuration", "inputSchema": {
  useCustomSMTP: {
...
var node89 = { "name": "Send SMS Notification", "id": "send_s_m_s_notification", "descripition": "Sends an SMS message to a specified phone number with customizable content", "inputSchema": {
  to: {
    name: "To",
...
var node90 = { "name": "Send SMS Reply", "id": "send_sms_reply", "descripition": "A description for SendSMSReply", "inputSchema": {
  to: {
    name: "Recipient Number",
...
var node91 = { "name": "Add Note to Contact", "id": "serviceminder_api_add_note_to_contact", "descripition": "Add a note to a customer's record. Useful for call logs and follow-up information.", "inputSchema": {
  noteBody: {
    name: "noteBody",
    description: "Content of the note",
    required: true,
...
var node92 = { "name": "Add or Update Contact", "id": "serviceminder_api_add_or_update_contact", "descripition": "Create a new contact or update existing one. Use when customer information needs to be added or modified.", "inputSchema": {
  campaign: {
    name: "campaign",
...
var node93 = { "name": "Book Appointment", "id": "serviceminder_api_book_appointment", "descripition": "Book a confirmed appointment for a customer. Use after finding available slots.", "inputSchema": {
  quantity: {
    name: "quantity",
...
var node94 = { "name": "Cancel Appointment", "id": "serviceminder_api_cancel_appointment", "descripition": "Cancel an existing appointment with optional reason.", "inputSchema": {
  updateNote: {
    name: "updateNote",
...
var node95 = { "name": "Find Appointments", "id": "serviceminder_api_find_appointments", "descripition": "Search for existing appointments by various criteria.", "inputSchema": {
  includeCompleted: {
...
var node96 = { "name": "Get All Service Agents", "id": "serviceminder_api_get_all_service_agents", "descripition": "Retrieve all service agents/technicians available for appointments.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node97 = { "name": "Get All Services", "id": "serviceminder_api_get_all_services", "descripition": "Retrieve all available services for booking appointments.", "inputSchema": {
  includeParts: {
    name: "includeParts",
...
var node98 = { "name": "Get Cancel Reasons", "id": "serviceminder_api_get_cancel_reasons", "descripition": "Get available cancellation reasons for appointments.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node99 = { "name": "Locate Contact", "id": "serviceminder_api_locate_contact", "descripition": "Search for existing contacts by name, phone, email, or address. Essential for identifying callers.", "inputSchema": {
  limit: {
    name: "limit",
...
var node100 = { "name": "Log Call", "id": "serviceminder_api_log_call", "descripition": "Log details of a phone call interaction.", "inputSchema": {
  callDetails: {
    name: "callDetails",
...
var node101 = { "name": "Query Appointments", "id": "serviceminder_api_query_appointments", "descripition": "Get appointments within a date range, useful for schedule viewing.", "inputSchema": {
  take: {
    name: "take",
    description: "Maximum number of results",
    required: false,
...
var node102 = { "name": "Quick Book Appointment", "id": "serviceminder_api_quick_book_appointment", "descripition": "Quickly book an appointment with customer information and service in one call.", "inputSchema": {
  internalNotes: {
    name: "internalNotes",
...
var node103 = { "name": "Search Available Slots", "id": "serviceminder_api_search_available_slots", "descripition": "Find available appointment slots for scheduling. Essential for booking appointments.", "inputSchema": {
  slotWindowDays: {
    name: "slotWindowDays",
...
var node104 = { "name": "Test Connection", "id": "serviceminder_api_test_connection", "descripition": "Test the API connection and authentication.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node105 = { "name": "Update Appointment", "id": "serviceminder_api_update_appointment", "descripition": "Modify an existing appointment. Use for rescheduling or updating appointment details.", "inputSchema": {
  updateNote: {
    name: "updateNote",
...
var node106 = { "name": "Add Call Summary Note", "id": "servicetitan_api_add_call_summary_note", "descripition": "Adds a call summary note to a job by appending to the existing job summary. Includes timestamp and formatted call details.", "inputSchema": {
  additionalDetails: {
...
var node108 = { "name": "Create Customer", "id": "servicetitan_api_create_customer", "descripition": "Creates a new customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
...
var node109 = { "name": "Create Customer Location", "id": "servicetitan_api_create_customer_location", "descripition": "Creates a new location for a customer in ServiceTitan.", "inputSchema": {
  name: {
    name: "name",
...
var node112 = { "name": "Get Appointments", "id": "servicetitan_api_get_appointments", "descripition": "Retrieves appointments for a specific job.", "inputSchema": {
  jobId: {
    name: "jobId",
    description: "The job ID.",
    required: true,
...
var node113 = { "name": "Get Available Technicians", "id": "servicetitan_api_get_available_technicians", "descripition": "Retrieves both regular available technicians with their free time slots AND the on-call technician for a specific date.", "inputSchema": {
  date: {
    name: "date",
...
var node114 = { "name": "Get Business Units", "id": "servicetitan_api_get_business_units", "descripition": "Retrieves all active business units from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node115 = { "name": "Get Campaigns", "id": "servicetitan_api_get_campaigns", "descripition": "Retrieves all active campaigns from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node116 = { "name": "Get Cancellation Reasons", "id": "servicetitan_api_get_cancellation_reasons", "descripition": "Retrieves all available job cancellation reasons.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node117 = { "name": "Get Customer by Phone", "id": "servicetitan_api_get_customer_by_phone", "descripition": "Retrieves customer information from ServiceTitan by phone number.", "inputSchema": {
  phone: {
    name: "phone",
...
var node118 = { "name": "Get Customer Locations", "id": "servicetitan_api_get_customer_locations", "descripition": "Retrieves location information for a customer from ServiceTitan by customer ID.", "inputSchema": {
  customerId: {
    name: "customerId",
...
var node119 = { "name": "Get Geo Address", "id": "servicetitan_api_get_geo_address", "descripition": "Geocodes an address using Google Maps Geocoding API. Takes a street address or ZIP code and returns geocoded address suggestions. Uses optional city, state, and country MCP properties to streamline search when provided.", "inputSchema": {
  street: {
    name: "street",
    description: "Street address or ZIP code to geocode.",
    required: true,
...
var node120 = { "name": "Get Job Types", "id": "servicetitan_api_get_job_types", "descripition": "Retrieves all active job types from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node121 = { "name": "Get Jobs by Customer", "id": "servicetitan_api_get_jobs_by_customer", "descripition": "Retrieves all jobs for a specific customer.", "inputSchema": {
  customerId: {
    name: "customerId",
    description: "The customer ID.",
    required: true,
...
var node122 = { "name": "Reschedule Appointment", "id": "servicetitan_api_reschedule_appointment", "descripition": "Reschedules an existing appointment in ServiceTitan.", "inputSchema": {
  arrivalWindowEnd: {
...
var node123 = { "name": "Update Customer", "id": "servicetitan_api_update_customer", "descripition": "Updates an existing customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
    description: "Array of contact objects (optional).",
    required: false,
...
var node124 = { "name": "Update Customer Contact", "id": "servicetitan_api_update_customer_contact", "descripition": "Updates contact details (email and/or phone) for a customer.", "inputSchema": {
  phone: {
    name: "phone",
...
var node125 = { "name": "Update Customer Details", "id": "servicetitan_api_update_customer_details", "descripition": "Updates comprehensive customer details including name, type, address, and tags.", "inputSchema": {
  tagTypeIds: {
    name: "tagTypeIds",
...
var node126 = { "name": "Update Job", "id": "servicetitan_api_update_job", "descripition": "Updates an existing job in ServiceTitan.", "inputSchema": {
  appointments: {
    name: "appointments",
...
var node127 = { "name": "Update Location Contact", "id": "servicetitan_api_update_location_contact", "descripition": "Updates contact details (email and/or phone) for a location.", "inputSchema": {
  phone: {
    name: "phone",
    description: "New phone number (optional).",
    required: false,
...
var node128 = { "name": "Service Titan Technicion Sms", "id": "service_titan_technicion_sms", "descripition": "This will trigger sending sms and follow up call to the technicion", "inputSchema": {}, "outputSchema": {
  firstPhoneNumber: {
...
var node129 = { "name": "Split For Test", "id": "split_for_test", "descripition": "Split workflow execution between testA and testB branches based on a ratio", "inputSchema": {
  splitRatio: {
...
var node130 = { "name": "Store Variable", "id": "store_variable", "descripition": "Stores a variable for later use", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
    description: "A unique key to identify the variable across different workflow runs. For example, if you use {{phone number}} variable of a lead as the unique key, the variable will be unique per phone number.",
    validationSchema: /.*/,
...
// src/waittime.ts
var node131 = { "name": "Wait Time", "id": "waittime", "descripition": "Pauses the workflow execution for a specified duration before proceeding to the next step", "inputSchema": {
  waitType: {
    name: "Wait Type",
...
var node132 = { "name": "Webhook", "id": "webhook_trigger", "descripition": "Starts a workflow when data is received from an external webhook, extracting contact information", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
...
// src/index.ts
var nodes = { add_note_to_lead_service_titan: node, add_tag_to_lead: node2, add_to_sms_campaign: node3, address_validation_api_get_geo_address: node4, apply_tag_service_titan: node5, certapro_api_get_events: node6, certapro_api_update_event: node7, certapro_v2_api_get_events: node8, certapro_v2_api_update_event: node9, checkcondition: node10, check_if_invoice_overdue: node11, custom_webhook: node12, extract_common_field: node13, extract_with_a_i: node14, get_agent_chat_history: node15, get_chat_response: node16, get_constant: node17, get_lead_service_titan: node18, get_live_staging_leads: node19, get_s_m_s_campaign_messages: node20, get_service_titan_recurring_service_estimates: node21, get_service_titan_accounts_receievables: node22, get_tags: node23, get_unassigned_recurring_events: node24, get_uploaded_leads_trigger: node25, get_variable: node26, housecall_v1_api_book_estimate: node27, housecall_v1_api_find_or_create_customer: node28, housecall_v1_api_get_customer: node29, housecall_v1_api_list_available_estimate_slots: node30, housecall_v1_api_search_customers_by_phone: node31, hubspot_crm_api_book_meeting: node32, hubspot_crm_api_book_meeting_slot: node33, hubspot_crm_api_create_crm_meeting: node34, hubspot_crm_api_create_contact: node35, hubspot_crm_api_create_meeting: node36, hubspot_crm_api_create_note: node37, hubspot_crm_api_get_available_time_slots: node38, hubspot_crm_api_get_crm_meeting: node39, hubspot_crm_api_get_contact: node40, hubspot_crm_api_get_meeting: node41, hubspot_crm_api_get_meeting_availability: node42, hubspot_crm_api_get_meeting_booking_info: node43, hubspot_crm_api_search_crm_meetings: node44, hubspot_crm_api_search_contacts: node45, hubspot_crm_api_search_meetings: node46, hubspot_crm_api_test_connection: node47, hubspot_crm_api_update_crm_meeting: node48, hubspot_crm_api_update_meeting: node49, inbound_call_trigger: node50, is_public_holiday: node51, make_call: node52, manual_trigger: node53, on_email_received: node54, on_new_appoinment_service_titan: node55, on_new_call_service_titan: node56, on_new_customer_service_titan: node57, on_new_estimate_service_titan: node58, on_new_invoice_service_titan: node59, on_new_job_or_project_note_service_titan: node60, on_new_job_service_titan: node61, on_new_lead_note_service_titan: node62, on_new_lead_service_titan: node63, on_new_payment_service_titan: node64, on_new_project_service_titan: node65, on_s_m_s_received: node66, on_tag_added: node67, on_updated_call_service_titan: node68, on_updated_estimate_service_titan: node69, on_website_vistor_indentified: node70, outreachgenius_calendar_book_slot: node71, outreachgenius_calendar_get_available_slots: node72, psa_api_add_company: node73, psa_api_add_contact: node74, psa_api_add_job: node75, psa_api_get_company: node76, psa_api_get_contact: node77, psa_api_get_job: node78, process_variable: node79, public_holiday_api_holiday_check_v1: node80, remove_tag_from_lead: node81, repeat_job: node82, run_another_workflow: node83, run_once_trigger: node84, sample_api_counter_tool: node85, sample_api_sample_tool: node86, send_direct_mail: node87, send_email_notification: node88, send_s_m_s_notification: node89, send_sms_reply: node90, serviceminder_api_add_note_to_contact: node91, serviceminder_api_add_or_update_contact: node92, serviceminder_api_book_appointment: node93, serviceminder_api_cancel_appointment: node94, serviceminder_api_find_appointments: node95, serviceminder_api_get_all_service_agents: node96, serviceminder_api_get_all_services: node97, serviceminder_api_get_cancel_reasons: node98, serviceminder_api_locate_contact: node99, serviceminder_api_log_call: node100, serviceminder_api_query_appointments: node101, serviceminder_api_quick_book_appointment: node102, serviceminder_api_search_available_slots: node103, serviceminder_api_test_connection: node104, serviceminder_api_update_appointment: node105, servicetitan_api_add_call_summary_note: node106, servicetitan_api_cancel_job: node107, servicetitan_api_create_customer: node108, servicetitan_api_create_customer_location: node109, servicetitan_api_create_job_for_existing_customer: node110, servicetitan_api_create_job_for_new_customer: node111, servicetitan_api_get_appointments: node112, servicetitan_api_get_available_technicians: node113, servicetitan_api_get_business_units: node114, servicetitan_api_get_campaigns: node115, servicetitan_api_get_cancellation_reasons: node116, servicetitan_api_get_customer_by_phone: node117, servicetitan_api_get_customer_locations: node118, servicetitan_api_get_geo_address: node119, servicetitan_api_get_job_types: node120, servicetitan_api_get_jobs_by_customer: node121, servicetitan_api_reschedule_appointment: node122, servicetitan_api_update_customer: node123, servicetitan_api_update_customer_contact: node124, servicetitan_api_update_customer_details: node125, servicetitan_api_update_job: node126, servicetitan_api_update_location_contact: node127, service_titan_technicion_sms: node128, split_for_test: node129, store_variable: node130, waittime: node131, webhook_trigger: node132 };
export {
  nodes
};
