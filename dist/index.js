...
var node127 = { "name": "Get Available Technicians", "id": "servicetitan_api_get_available_technicians", "descripition": "Retrieves both regular available technicians with their free time slots AND the on-call technician for a specific date.", "inputSchema": {
  summary: {
    name: "summary",
...
// src/you_can_book_me_api_get_available_slots.ts
var node147 = { "name": "Get Available Slots", "id": "you_can_book_me_api_get_available_slots", "descripition": "Returns available booking slots over the next 14 days for residential calendars whose team tags overlap any of the provided tags. Tag matching is exact and any-match.", "inputSchema": {
  tags: {
    name: "tags",
  ...
  result: {
    name: "Result",
    description: "Output of tool Get Available Slots from API You Can Book Me API",
    example: "",
    validator: (value) => true
  }
}, "groups": ["You Can Book Me API", "Get Available Slots"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/on_you_can_book_me_api_get_available_slots_called.ts
var node148 = { "name": "On Get Available Slots Called", "id": "on_you_can_book_me_api_get_available_slots_called", "descripition": "Triggers when Get Available Slots is called via MCP API (You Can Book Me API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/you_can_book_me_api_book_slot.ts
var node149 = { "name": "Book Slot", "id": "you_can_book_me_api_book_slot", "descripition": "Records a booking selection \u2014 captures the chosen calendar, slot owner, time, and customer details. Does not write the event to the underlying calendar; that is handled downstream.", "inputSchema": {
  notes: {
    name: "notes",
    description: "Additional notes",
    required: false,
...
}, "groups": ["You Can Book Me API", "Book Slot"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/on_you_can_book_me_api_book_slot_called.ts
var node150 = { "name": "On Book Slot Called", "id": "on_you_can_book_me_api_book_slot_called", "descripition": "Triggers when Book Slot is called via MCP API (You Can Book Me API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
  ...
  ownerEmail: {
    name: "ownerEmail",
    description: "Input parameter: Email of the calendar owner for the selected slot (from getAvailableSlots).",
    example: "",
    validator: (value) => true
  },
  ownerName: {
    name: "ownerName",
    description: "Input parameter: Name of the calendar owner for the selected slot (from getAvailableSlots).",
    example: "",
    validator: (value) => true
  },
  calendarId: {
    name: "calendarId",
    description: "Input parameter: Cronofy calendar id of the selected slot (from getAvailableSlots).",
    example: "",
    validator: (value) => true
  },
  startTime: {
    name: "startTime",
    description: "Input parameter: Start time of the chosen slot (ISO 8601, e.g. '2026-05-01T14:00:00-04:00'). Must be one of the slots returned by getAvailableSlots.",
    example: "",
    validator: (value) => true
  },
  result: {
