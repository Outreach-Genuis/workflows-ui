...
var node12 = { "name": "Send SMS Notification", "id": "send_s_m_s_notification", "descripition": "Sends an SMS message to a specified phone number with customizable content", "inputSchema": {
  to: {
    name: "To",
...
var node13 = { "name": "Send SMS Reply (Deprecated)", "id": "send_sms_reply", "descripition": "A description for SendSMSReply", "inputSchema": {
  to: {
    name: "Recipient Number",
...
var node14 = { "name": "Send SMS Reply V2", "id": "send_sms_reply_v2", "descripition": "Sends an SMS reply with the sender phone number auto-inferred by the client. Supports parameter overrides for agent configuration.", "inputSchema": {
  to: {
    name: "Recipient Number",
    description: "Phone number to send the SMS reply to",
    validationSchema: /.*/,
...
var node15 = { "name": "Check Condition", "id": "checkcondition", "descripition": "Evaluates a condition comparing values with various operators, including AI-powered question answering", "inputSchema": {
  value: {
    name: "Value",
...
// src/repeat_job.ts
var node16 = { "name": "Repeat Job", "id": "repeat_job", "descripition": "A description for RepeatJob", "inputSchema": {
  repeatType: {
    name: "Repeat Type",
...
var node17 = { "name": "Run Another Workflow", "id": "run_another_workflow", "descripition": "A description for RunAnotherWorkflow", "inputSchema": {
  workflowCode: {
    name: "Workflow Code",
...
// src/waittime.ts
var node19 = { "name": "Wait Time", "id": "waittime", "descripition": "Pauses the workflow execution for a specified duration before proceeding to the next step", "inputSchema": {
  waitType: {
    name: "Wait Type",
...
var node20 = { "name": "Book Slot", "id": "outreachgenius_calendar_book_slot", "descripition": "Book a Cronofy calendar slot for an event", "inputSchema": {
  timezone: {
    name: "timezone",
...
var node21 = { "name": "Get Available Slots", "id": "outreachgenius_calendar_get_available_slots", "descripition": "Return available Cronofy slots for an eventId (mapped via project/zip if provided)", "inputSchema": {
  timezone: {
    name: "timezone",
    description: "Timezone",
    required: false,
...
var node23 = { "name": "Get Events", "id": "certapro_api_get_events", "descripition": 'Retrieves available calendar events/slots filtered by the configured filterName. Events are filtered to only show slots where the summary matches the filter (e.g., "ALL" for available slots).', "inputSchema": {
  zipCode: {
    name: "zipCode",
    description: "Zip code of the customer",
    required: false,
...
var node24 = { "name": "Update Event", "id": "certapro_api_update_event", "descripition": "Books/updates a calendar event with customer information. Takes an event_uid from the available slots and updates it with customer details.", "inputSchema": {
  notes: {
    name: "notes",
...
var node25 = { "name": "Get Events", "id": "certapro_v2_api_get_events", "descripition": 'Retrieves available calendar events/slots filtered by the configured filterName. Events are filtered to only show slots where the summary matches the filter (e.g., "ALL" for available slots).', "inputSchema": {
  zipCode: {
    name: "zipCode",
    description: "Zip code of the customer",
    required: false,
...
var node26 = { "name": "Update Event", "id": "certapro_v2_api_update_event", "descripition": "Books/updates a calendar event with customer information. Takes an event_uid from the available slots and updates it with customer details.", "inputSchema": {
  notes: {
    name: "notes",
    description: "Additional notes",
    required: false,
...
var node27 = { "name": "Get Events", "id": "certapro_v3_api_get_events", "descripition": "Retrieves available calendar slots by finding teams matching the zip code and team type, then filtering each calendar's events using its configured filter rules.", "inputSchema": {
  teamType: {
    name: "teamType",
...
var node28 = { "name": "Update Event", "id": "certapro_v3_api_update_event", "descripition": "Books/updates a calendar event with customer information. Takes an event_uid from the available slots and updates it with customer details.", "inputSchema": {
  notes: {
    name: "notes",
    description: "Additional notes",
    required: false,
...
var node29 = { "name": "Forward To Agent", "id": "genesys_cloud_api_forward_to_agent", "descripition": "Forward the current call to a human agent. Automatically saves session data to Genesys and initiates conversation stitching.", "inputSchema": {
  summary: {
    name: "summary",
...
var node30 = { "name": "Get Appointment Slots", "id": "genesys_cloud_api_get_appointment_slots", "descripition": "Retrieves available appointment slots from CertaPro by zip code. Returns a list of available time slots for scheduling estimates.", "inputSchema": {
  zipCode: {
    name: "zipCode",
...
var node31 = { "name": "Submit Lead", "id": "genesys_cloud_api_submit_lead", "descripition": "Submits a new lead to CertaPro with customer information, job details, and selected appointment. Returns a confirmation number on success.", "inputSchema": {
  appointmentId: {
    name: "appointmentId",
...
var node32 = { "name": "Book Estimate", "id": "housecall_v1_api_book_estimate", "descripition": "Create and schedule an estimate with required last name, free estimate line item, bookable employees, and call summary note.", "inputSchema": {
  callSummary: {
    name: "call_summary",
...
var node33 = { "name": "Find Or Create Customer", "id": "housecall_v1_api_find_or_create_customer", "descripition": "Lookup by phone and create if not found (returns the single customer record).", "inputSchema": {
  lastName: {
    name: "last_name",
...
var node34 = { "name": "Get Customer", "id": "housecall_v1_api_get_customer", "descripition": "Retrieve a customer by ID from Housecall.", "inputSchema": {
  id: {
    name: "id",
...
var node35 = { "name": "List Available Estimate Slots", "id": "housecall_v1_api_list_available_estimate_slots", "descripition": "Return available estimate slots for the given date with bookable employees.", "inputSchema": {
  date: {
    name: "date",
...
var node36 = { "name": "Search Customers By Phone", "id": "housecall_v1_api_search_customers_by_phone", "descripition": "Find existing customers using a phone number provided during the call.", "inputSchema": {
  phone: {
    name: "phone",
...
var node37 = { "name": "Book Meeting Slot", "id": "hubspot_crm_api_book_meeting_slot", "descripition": "Book a meeting using a time slot ID from the availability results.", "inputSchema": {
  locale: {
    name: "locale",
...
var node38 = { "name": "Create Contact", "id": "hubspot_crm_api_create_contact", "descripition": "Create a new contact in HubSpot CRM with contact information.", "inputSchema": {
  jobtitle: {
    name: "jobtitle",
...
var node39 = { "name": "Create Note", "id": "hubspot_crm_api_create_note", "descripition": "Create a note in HubSpot and associate it with contacts.", "inputSchema": {
  contactIds: {
    name: "contactIds",
...
var node40 = { "name": "Get Available Time Slots", "id": "hubspot_crm_api_get_available_time_slots", "descripition": "Get human-readable available time slots for booking meetings.", "inputSchema": {
  days: {
    name: "days",
...
var node42 = { "name": "Get Meeting Booking Info", "id": "hubspot_crm_api_get_meeting_booking_info", "descripition": "Get booking information and availability for a meeting link.", "inputSchema": {
  monthOffset: {
    name: "monthOffset",
...
var node43 = { "name": "Search Contacts", "id": "hubspot_crm_api_search_contacts", "descripition": "Search for contacts in HubSpot using various criteria.", "inputSchema": {
  limit: {
    name: "limit",
...
var node44 = { "name": "Test Connection", "id": "hubspot_crm_api_test_connection", "descripition": "Test the HubSpot API connection and authentication.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node46 = { "name": "Sample Tool", "id": "sample_api_sample_tool", "descripition": "This is a sample tool within the Sample API.", "inputSchema": {
  param1: {
    name: "param1",
...
var node47 = { "name": "Counter Tool", "id": "sample_api_counter_tool", "descripition": "This tool increments a counter stored in the session.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node48 = { "name": "Locate Contact", "id": "serviceminder_api_locate_contact", "descripition": "Search for existing contacts by name, phone, email, or address. Essential for identifying callers.", "inputSchema": {
  limit: {
    name: "limit",
...
var node49 = { "name": "Add or Update Contact", "id": "serviceminder_api_add_or_update_contact", "descripition": "Create a new contact or update existing one. Use when customer information needs to be added or modified.", "inputSchema": {
  campaign: {
    name: "campaign",
...
var node50 = { "name": "Add Note to Contact", "id": "serviceminder_api_add_note_to_contact", "descripition": "Add a note to a customer's record. Useful for call logs and follow-up information.", "inputSchema": {
  noteBody: {
    name: "noteBody",
    description: "Content of the note",
    required: true,
...
var node51 = { "name": "Search Available Slots", "id": "serviceminder_api_search_available_slots", "descripition": "Find available appointment slots for scheduling. Essential for booking appointments.", "inputSchema": {
  slotWindowDays: {
    name: "slotWindowDays",
...
var node52 = { "name": "Book Appointment", "id": "serviceminder_api_book_appointment", "descripition": "Book a confirmed appointment for a customer. Use after finding available slots.", "inputSchema": {
  quantity: {
    name: "quantity",
...
var node53 = { "name": "Log Call", "id": "serviceminder_api_log_call", "descripition": "Log details of a phone call interaction.", "inputSchema": {
  callDetails: {
    name: "callDetails",
...
var node54 = { "name": "Get Job", "id": "psa_api_get_job", "descripition": "Retrieve job details by ID from PSA system.", "inputSchema": {
  jobId: {
    name: "jobId",
...
var node55 = { "name": "Get Company", "id": "psa_api_get_company", "descripition": "Retrieve company details by ID from PSA system.", "inputSchema": {
  companyId: {
    name: "companyId",
...
var node56 = { "name": "Get Contact", "id": "psa_api_get_contact", "descripition": "Retrieve contact details by ID from PSA system.", "inputSchema": {
  contactId: {
    name: "contactId",
...
var node57 = { "name": "Add Company", "id": "psa_api_add_company", "descripition": "Create a new company in PSA system with primary site and optional contact info.", "inputSchema": {
  phone: {
    name: "phone",
    description: "Phone number",
    required: false,
...
var node58 = { "name": "Add Contact", "id": "psa_api_add_contact", "descripition": "Create a new contact in PSA system associated with the configured company.", "inputSchema": {
  phone: {
    name: "phone",
...
var node59 = { "name": "Add Job", "id": "psa_api_add_job", "descripition": "Create a new job in PSA system. Only name is required.", "inputSchema": {
  siteName: {
    name: "siteName",
    description: "Site name",
    required: false,
...
var node60 = { "name": "Get Campaigns", "id": "servicetitan_api_get_campaigns", "descripition": "Retrieves all active campaigns from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node61 = { "name": "Get Business Units", "id": "servicetitan_api_get_business_units", "descripition": "Retrieves all active business units from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node62 = { "name": "Get Job Types", "id": "servicetitan_api_get_job_types", "descripition": "Retrieves all active job types from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node63 = { "name": "Get Geo Address", "id": "servicetitan_api_get_geo_address", "descripition": "Geocodes an address using Google Maps Geocoding API. Takes a street address or ZIP code and returns geocoded address suggestions. Uses optional city, state, and country MCP properties to streamline search when provided.", "inputSchema": {
  street: {
    name: "street",
    description: "Street address or ZIP code to geocode.",
    required: true,
...
var node64 = { "name": "Get Customer by Phone", "id": "servicetitan_api_get_customer_by_phone", "descripition": "Retrieves customer information from ServiceTitan by phone number.", "inputSchema": {
  phone: {
    name: "phone",
...
var node65 = { "name": "Get Customer Locations", "id": "servicetitan_api_get_customer_locations", "descripition": "Retrieves location information for a customer from ServiceTitan by customer ID.", "inputSchema": {
  customerId: {
    name: "customerId",
...
var node66 = { "name": "Create Customer", "id": "servicetitan_api_create_customer", "descripition": "Creates a new customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
...
var node67 = { "name": "Update Customer", "id": "servicetitan_api_update_customer", "descripition": "Updates an existing customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
    description: "Array of contact objects (optional).",
    required: false,
...
var node68 = { "name": "Create Customer Location", "id": "servicetitan_api_create_customer_location", "descripition": "Creates a new location for a customer in ServiceTitan.", "inputSchema": {
  name: {
    name: "name",
...
var node71 = { "name": "Get Jobs by Customer", "id": "servicetitan_api_get_jobs_by_customer", "descripition": "Retrieves all jobs for a specific customer.", "inputSchema": {
  customerId: {
    name: "customerId",
    description: "The customer ID.",
    required: true,
...
var node72 = { "name": "Update Job", "id": "servicetitan_api_update_job", "descripition": "Updates an existing job in ServiceTitan.", "inputSchema": {
  appointments: {
    name: "appointments",
...
var node73 = { "name": "Get Available Technicians", "id": "servicetitan_api_get_available_technicians", "descripition": "Retrieves both regular available technicians with their free time slots AND the on-call technician for a specific date.", "inputSchema": {
  summary: {
    name: "summary",
...
var node74 = { "name": "Get Active Technicians", "id": "servicetitan_api_get_active_technicians", "descripition": "Retrieves all active technicians from ServiceTitan Settings API.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node75 = { "name": "Get Appointments", "id": "servicetitan_api_get_appointments", "descripition": "Retrieves appointments for a specific job.", "inputSchema": {
  jobId: {
    name: "jobId",
...
var node76 = { "name": "Reschedule Appointment", "id": "servicetitan_api_reschedule_appointment", "descripition": "Reschedules an existing appointment in ServiceTitan.", "inputSchema": {
  arrivalWindowEnd: {
...
var node77 = { "name": "Update Location Contact", "id": "servicetitan_api_update_location_contact", "descripition": "Updates contact details (email and/or phone) for a location.", "inputSchema": {
  phone: {
    name: "phone",
...
var node78 = { "name": "Update Customer Contact", "id": "servicetitan_api_update_customer_contact", "descripition": "Updates contact details (email and/or phone) for a customer.", "inputSchema": {
  phone: {
    name: "phone",
    description: "New phone number (optional).",
    required: false,
...
var node79 = { "name": "Get Cancellation Reasons", "id": "servicetitan_api_get_cancellation_reasons", "descripition": "Retrieves all available job cancellation reasons.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node81 = { "name": "Update Customer Details", "id": "servicetitan_api_update_customer_details", "descripition": "Updates comprehensive customer details including name, type, address, and tags.", "inputSchema": {
  tagTypeIds: {
    name: "tagTypeIds",
...
var node82 = { "name": "Add Call Summary Note", "id": "servicetitan_api_add_call_summary_note", "descripition": "Adds a call summary note to a job by appending to the existing job summary. Includes timestamp and formatted call details.", "inputSchema": {
  additionalDetails: {
...
var node83 = { "name": "Add Tag To Lead (Deprecated)", "id": "add_tag_to_lead", "descripition": "Assigns a specified tag to a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
...
var node84 = { "name": "Add Tag To Lead V2", "id": "add_tag_to_lead_v2", "descripition": "Assigns a specified tag to a lead identified by email or phone number, with a tag dropdown selector", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
var node85 = { "name": "Check If Invoice Overdue", "id": "check_if_invoice_overdue", "descripition": "A description for CheckIfInvoiceOverdue", "inputSchema": {
  invoiceId: {
    name: "Invoice ID",
...
var node86 = { "name": "Get Live Staging Leads", "id": "get_live_staging_leads", "descripition": "A description for GetLiveStagingLeads", "inputSchema": {
  type: {
    name: "Lead Type",
...
// src/get_tags.ts
var node87 = { "name": "Get Tags", "id": "get_tags", "descripition": "Retrieves all tags associated with a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
var node88 = { "name": "Remove Tag From Lead (Deprecated)", "id": "remove_tag_from_lead", "descripition": "Removes a specified tag from a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
var node89 = { "name": "Remove Tag From Lead V2", "id": "remove_tag_from_lead_v2", "descripition": "Removes a specified tag from a lead identified by email or phone number, with a tag dropdown selector", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
var node90 = { "name": "Add Note To Lead Service Titan", "id": "add_note_to_lead_service_titan", "descripition": "Adds a note to a lead in ServiceTitan", "inputSchema": {
  leadId: {
    name: "Lead ID",
...
var node91 = { "name": "Apply Tag Service Titan", "id": "apply_tag_service_titan", "descripition": "Applies a tag to a customer in ServiceTitan", "inputSchema": {
  tagTypeId: {
...
var node92 = { "name": "Get Lead Service Titan", "id": "get_lead_service_titan", "descripition": "Get details of a specific lead from ServiceTitan", "inputSchema": {
  customerId: {
    name: "Customer ID",
...
var node93 = { "name": "Get Service Titan Recurring Service Estimates", "id": "get_service_titan_recurring_service_estimates", "descripition": "A description for GetServiceTitanRecurringServiceEstimates", "inputSchema": {}, "outputSchema": {}, "groups": ["system", "ServiceTitan"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_service_titan_accounts_receievables.ts
var node94 = { "name": "Get Service Titan Unpaid Invoices", "id": "get_service_titan_accounts_receievables", "descripition": "Retrieves unpaid invoices from ServiceTitan that are past a specified number of days due.", "inputSchema": {
  daysPastDue: {
    name: "Days Past Due",
...
var node95 = { "name": "Get Unassigned Recurring Events", "id": "get_unassigned_recurring_events", "descripition": "A description for GetUnassignedRecurringServiceEvents", "inputSchema": {
  nextNDays: {
    name: "Next N Days",
...
var node96 = { "name": "Service Titan Technicion Sms", "id": "service_titan_technicion_sms", "descripition": "This will trigger sending sms and follow up call to the technicion", "inputSchema": {}, "outputSchema": {
  firstPhoneNumber: {
...
var node97 = { "name": "Custom Webhook", "id": "custom_webhook", "descripition": "Makes custom HTTP requests to external APIs with configurable methods, headers, and body content", "inputSchema": {
  url: {
    name: "URL",
...
var node98 = { "name": "Get Uploaded Leads Trigger", "id": "get_uploaded_leads_trigger", "descripition": "Triggers a workflow when new leads are uploaded, with options for scheduling and limiting the number of leads", "inputSchema": {
  numLeadsToFetch: {
...
var node99 = { "name": "Inbound Call Trigger", "id": "inbound_call_trigger", "descripition": "Triggers a workflow when an inbound call is received, providing caller details and call transcription", "inputSchema": {}, "outputSchema": {
  phone: {
    name: "Phone Number",
...
var node100 = { "name": "Manual Trigger", "id": "manual_trigger", "descripition": "A description for ManualTrigger", "inputSchema": {}, "outputSchema": {
  phone: {
    name: "Phone Number",
    description: "The phone number to send notifications to",
    required: false,
...
var node102 = { "name": "ServiceTitan New Appoinment", "id": "on_new_appoinment_service_titan", "descripition": "Triggers when a new appointment is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node103 = { "name": "ServiceTitan New Call", "id": "on_new_call_service_titan", "descripition": "Triggers when a new call is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  createdOn: {
    name: "Created On",
...
var node104 = { "name": "ServiceTitan New Customer", "id": "on_new_customer_service_titan", "descripition": "Triggers when a new customer is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The unique identifier for the customer",
    example: 12345,
...
var node105 = { "name": "ServiceTitan New Estimate", "id": "on_new_estimate_service_titan", "descripition": "Triggers when a new estimate is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node106 = { "name": "ServiceTitan New Invoice", "id": "on_new_invoice_service_titan", "descripition": "Triggers when a new invoice is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node107 = { "name": "ServiceTitan New Job Or Project Note", "id": "on_new_job_or_project_note_service_titan", "descripition": "Triggers when a new note is added to a job or project in ServiceTitan", "inputSchema": {
  entityType: {
    name: "Note Type",
...
var node108 = { "name": "ServiceTitan New Job", "id": "on_new_job_service_titan", "descripition": "Triggers when a new job is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The job ID",
    example: 12345,
...
var node109 = { "name": "ServiceTitan New Lead Note", "id": "on_new_lead_note_service_titan", "descripition": "Triggers when a new note is added to a lead in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node110 = { "name": "ServiceTitan New Lead", "id": "on_new_lead_service_titan", "descripition": "Triggers when a new lead is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The ID of the lead",
    example: 123,
...
var node111 = { "name": "ServiceTitan New Payment", "id": "on_new_payment_service_titan", "descripition": "Triggers when a new payment is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node112 = { "name": "ServiceTitan New Project", "id": "on_new_project_service_titan", "descripition": "Triggers when a new project is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node113 = { "name": "On SMS Received", "id": "on_s_m_s_received", "descripition": "A description for OnSMSReceived", "inputSchema": {}, "outputSchema": {
  customerNumber: {
...
// src/on_tag_added.ts
var node114 = { "name": "On Tag Added", "id": "on_tag_added", "descripition": "Triggers a workflow when a tag is added to a lead, providing lead information", "inputSchema": {}, "outputSchema": {
  tag: {
    name: "Tag",
...
var node115 = { "name": "ServiceTitan Updated Call", "id": "on_updated_call_service_titan", "descripition": "Triggers when a call is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["system", "ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };
...
var node117 = { "name": "On Website Visitor Identified", "id": "on_website_vistor_indentified", "descripition": "Triggers when an anonymous Website visitor is identified via our Pixel Tag", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
...
var node118 = { "name": "Run Once", "id": "run_once_trigger", "descripition": "A trigger node that runs only once when the workflow is activated", "inputSchema": {}, "outputSchema": {}, "groups": ["system", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/webhook_trigger.ts
var node119 = { "name": "Webhook", "id": "webhook_trigger", "descripition": "Starts a workflow when data is received from an external webhook, extracting contact information", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
...
var node120 = { "name": "Is Public Holiday", "id": "is_public_holiday", "descripition": "Check if current date is a public holiday in the US", "inputSchema": {
  holidays: {
    name: "Holidays",
...
var node121 = { "name": "Extract Common Field", "id": "extract_common_field", "descripition": "Extracts common fields like date, email, or phone number from text using predefined patterns.", "inputSchema": {
  rawText: {
    name: "Raw Text",
...
var node122 = { "name": "Extract With AI", "id": "extract_with_a_i", "descripition": "Extracts specific information from text using AI analysis based on provided instructions", "inputSchema": {
  rawText: {
    name: "Raw Text",
    description: "The text to extract information from",
    validationSchema: /.*/,
...
// src/get_constant.ts
var node123 = { "name": "Get Constant", "id": "get_constant", "descripition": "Returns various useful constants like time information, system values, and random data", "inputSchema": {
  constantType: {
    name: "Constant Type",
...
// src/get_variable.ts
var node124 = { "name": "Get Variable", "id": "get_variable", "descripition": "Gets the value of a stored variable", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
...
var node125 = { "name": "Process Variable", "id": "process_variable", "descripition": "Processes a variable with various string, number, and JSON operations", "inputSchema": {
  value: {
    name: "Value",
...
var node126 = { "name": "Store Variable", "id": "store_variable", "descripition": "Stores a variable for later use", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
    description: "A unique key to identify the variable across different workflow runs. For example, if you use {{phone number}} variable of a lead as the unique key, the variable will be unique per phone number.",
    validationSchema: /.*/,
...
// src/index.ts
var nodes = { categorise_call: node, get_agent_chat_history: node2, get_agent_chat_history_v2: node3, get_chat_response: node4, get_chat_response_v2: node5, add_to_sms_campaign: node6, get_s_m_s_campaign_messages: node7, make_call: node8, make_call_v2: node9, send_direct_mail: node10, send_email_notification: node11, send_s_m_s_notification: node12, send_sms_reply: node13, send_sms_reply_v2: node14, checkcondition: node15, repeat_job: node16, run_another_workflow: node17, split_for_test: node18, waittime: node19, outreachgenius_calendar_book_slot: node20, outreachgenius_calendar_get_available_slots: node21, address_validation_api_get_geo_address: node22, certapro_api_get_events: node23, certapro_api_update_event: node24, certapro_v2_api_get_events: node25, certapro_v2_api_update_event: node26, certapro_v3_api_get_events: node27, certapro_v3_api_update_event: node28, genesys_cloud_api_forward_to_agent: node29, genesys_cloud_api_get_appointment_slots: node30, genesys_cloud_api_submit_lead: node31, housecall_v1_api_book_estimate: node32, housecall_v1_api_find_or_create_customer: node33, housecall_v1_api_get_customer: node34, housecall_v1_api_list_available_estimate_slots: node35, housecall_v1_api_search_customers_by_phone: node36, hubspot_crm_api_book_meeting_slot: node37, hubspot_crm_api_create_contact: node38, hubspot_crm_api_create_note: node39, hubspot_crm_api_get_available_time_slots: node40, hubspot_crm_api_get_contact: node41, hubspot_crm_api_get_meeting_booking_info: node42, hubspot_crm_api_search_contacts: node43, hubspot_crm_api_test_connection: node44, public_holiday_api_holiday_check_v1: node45, sample_api_sample_tool: node46, sample_api_counter_tool: node47, serviceminder_api_locate_contact: node48, serviceminder_api_add_or_update_contact: node49, serviceminder_api_add_note_to_contact: node50, serviceminder_api_search_available_slots: node51, serviceminder_api_book_appointment: node52, serviceminder_api_log_call: node53, psa_api_get_job: node54, psa_api_get_company: node55, psa_api_get_contact: node56, psa_api_add_company: node57, psa_api_add_contact: node58, psa_api_add_job: node59, servicetitan_api_get_campaigns: node60, servicetitan_api_get_business_units: node61, servicetitan_api_get_job_types: node62, servicetitan_api_get_geo_address: node63, servicetitan_api_get_customer_by_phone: node64, servicetitan_api_get_customer_locations: node65, servicetitan_api_create_customer: node66, servicetitan_api_update_customer: node67, servicetitan_api_create_customer_location: node68, servicetitan_api_create_job_for_new_customer: node69, servicetitan_api_create_job_for_existing_customer: node70, servicetitan_api_get_jobs_by_customer: node71, servicetitan_api_update_job: node72, servicetitan_api_get_available_technicians: node73, servicetitan_api_get_active_technicians: node74, servicetitan_api_get_appointments: node75, servicetitan_api_reschedule_appointment: node76, servicetitan_api_update_location_contact: node77, servicetitan_api_update_customer_contact: node78, servicetitan_api_get_cancellation_reasons: node79, servicetitan_api_cancel_job: node80, servicetitan_api_update_customer_details: node81, servicetitan_api_add_call_summary_note: node82, add_tag_to_lead: node83, add_tag_to_lead_v2: node84, check_if_invoice_overdue: node85, get_live_staging_leads: node86, get_tags: node87, remove_tag_from_lead: node88, remove_tag_from_lead_v2: node89, add_note_to_lead_service_titan: node90, apply_tag_service_titan: node91, get_lead_service_titan: node92, get_service_titan_recurring_service_estimates: node93, get_service_titan_accounts_receievables: node94, get_unassigned_recurring_events: node95, service_titan_technicion_sms: node96, custom_webhook: node97, get_uploaded_leads_trigger: node98, inbound_call_trigger: node99, manual_trigger: node100, on_email_received: node101, on_new_appoinment_service_titan: node102, on_new_call_service_titan: node103, on_new_customer_service_titan: node104, on_new_estimate_service_titan: node105, on_new_invoice_service_titan: node106, on_new_job_or_project_note_service_titan: node107, on_new_job_service_titan: node108, on_new_lead_note_service_titan: node109, on_new_lead_service_titan: node110, on_new_payment_service_titan: node111, on_new_project_service_titan: node112, on_s_m_s_received: node113, on_tag_added: node114, on_updated_call_service_titan: node115, on_updated_estimate_service_titan: node116, on_website_vistor_indentified: node117, run_once_trigger: node118, webhook_trigger: node119, is_public_holiday: node120, extract_common_field: node121, extract_with_a_i: node122, get_constant: node123, get_variable: node124, process_variable: node125, store_variable: node126 };
export {
  nodes
};
