...
// src/categorise_call.ts
var node = { "name": "Categorise Call", "id": "categorise_call", "descripition": "Categorises a call transcript into one of up to 6 user-defined categories using AI", "inputSchema": {
  calltranscript: {
...
}, "groups": ["system"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_agent_chat_history_v2.ts
var node3 = { "name": "Get Agent Chat History V2", "id": "get_agent_chat_history_v2", "descripition": "Retrieves the chat history for an agent and communication channel, with agent and channel IDs auto-inferred by the client. Supports parameter overrides for agent configuration.", "inputSchema": {
  sessionType: {
    name: "Session Type",
    description: "Type of the chat session",
    validationSchema: /^(sms|email|whatsapp|messenger)$/,
  ...
  parameterOverrides: {
    ...
    description: "Custom parameter overrides for agent configuration. These override the default agent settings.",
    validationSchema: /.*/,
...
var node4 = { "name": "Process Chat Response (Deprecated)", "id": "get_chat_response", "descripition": "Processes a chat message and sends a reply from the assigned agent using the specified communication channel.", "inputSchema": {
  sessionType: {
    name: "Session Type",
    description: "Type of the chat session",
    validationSchema: /^(sms|email|whatsapp|messenger)$/,
  ...
  extraInstructions: {
    ...
    validationSchema: /.*/,
    errorMessage: "Extra instructions must be less than 1000 characters if provided",
    required: false,
    input: {
      type: "textarea",
...
// src/get_chat_response_v2.ts
var node5 = { "name": "Process Chat Response V2", "id": "get_chat_response_v2", "descripition": "Processes a chat message and sends a reply, with agent and channel IDs auto-inferred by the client. Supports parameter overrides for agent configuration.", "inputSchema": {
  sessionType: {
    name: "Session Type",
    description: "Type of the chat session",
    validationSchema: /^(sms|email|whatsapp|messenger)$/,
...
var node6 = { "name": "Add To SMS Campaign", "id": "add_to_sms_campaign", "descripition": "Adds a contact to an SMS campaign identified by campaign ID", "inputSchema": {
  phone: {
    name: "Phone Number",
...
}, "outputSchema": {}, "groups": ["system", "Communication", "SMS", "Lead Management"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_s_m_s_campaign_messages.ts
var node7 = { "name": "Get SMS Campaign Messages", "id": "get_s_m_s_campaign_messages", "descripition": "Retrieves all messages from a specific SMS campaign by campaign ID", "inputSchema": {
  phone: {
    name: "Phone Number",
...
}, "groups": ["system", "Communication", "SMS", "Data"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/make_call.ts
var node8 = { "name": "Make Call (Deprecated)", "id": "make_call", "descripition": "Places an outbound phone call to the specified number with customizable script and voice options", "inputSchema": {
  phone: {
    name: "Phone Number",
  ...
  callAnyTime: {
    name: "Call Any Time",
    description: "Allow this call to be placed at any time, ignoring calling-hours restrictions",
  ...
  hangupReason: {
    ...
    example: "user_hangup",
    required: false,
    validator: (reason) => ["user_hangup", "ai_hangup", "silence_timeout", "other"].includes(
      reason
    )
  }
...
// src/make_call_v2.ts
var node9 = { "name": "Make Call V2", "id": "make_call_v2", "descripition": "Places an outbound phone call with agent and phone number auto-inferred by the client. Supports parameter overrides for agent configuration.", "inputSchema": {
  extraInstructions: {
    name: "Extra Instructions",
    description: "Additional instructions for the agent",
    validationSchema: /.*/,
  ...
  parameterOverrides: {
    name: "Parameter Overrides",
    description: "Custom parameter overrides for agent configuration. These override the default agent settings for this call.",
    validationSchema: /.*/,
    errorMessage: "Invalid parameter overrides",
    required: false,
    input: {
...
var node10 = { "name": "Send Direct Mail", "id": "send_direct_mail", "descripition": "Sends a physical direct mail using a service provider", "inputSchema": {
  productId: {
    name: "Product ID",
...
}, "outputSchema": {}, "groups": ["system", "Communication", "Direct Mail"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 7.5 };

// src/send_email_notification.ts
var node11 = { "name": "Send Email Notification", "id": "send_email_notification", "descripition": "Sends an email message with customizable from, to, cc, bcc fields and SMTP configuration", "inputSchema": {
  useCustomSMTP: {
...
}, "outputSchema": {}, "groups": ["system", "Communication", "Email"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/send_ringless_voicemail.ts
var node12 = { "name": "Send Ringless Voicemail", "id": "send_ringless_voicemail", "descripition": "Drops a voicemail directly into the recipient's inbox via DropCowboy without ringing their phone. Provide the destination phone number, the text to be spoken, and the recipient's postal code.", "inputSchema": {
  to: {
    name: "To",
  ...
  text: {
    ...
    description: "The text that will be converted to speech and left as a voicemail",
  ...
  postalCode: {
    name: "Postal Code",
    description: "Recipient's postal/ZIP code. Used by DropCowboy to pick a regionally appropriate caller ID.",
...
}, "groups": ["system", "Communication", "Voicemail"], "branches": { "success": { "id": "success", "name": "Success", "description": "Voicemail drop queued successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Voicemail drop failed" } }, "isTriggerNode": false, "cost": 0 };

// src/send_s_m_s_notification.ts
var node13 = { "name": "Send SMS Notification", "id": "send_s_m_s_notification", "descripition": "Sends an SMS message to a specified phone number with customizable content", "inputSchema": {
  to: {
    name: "To",
...
}, "outputSchema": {}, "groups": ["system", "Communication", "SMS"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0.35 };

// src/send_sms_reply.ts
var node14 = { "name": "Send SMS Reply (Deprecated)", "id": "send_sms_reply", "descripition": "A description for SendSMSReply", "inputSchema": {
  to: {
    name: "Recipient Number",
...
}, "outputSchema": {}, "groups": ["system"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/send_sms_reply_v2.ts
var node15 = { "name": "Send SMS Reply V2", "id": "send_sms_reply_v2", "descripition": "Sends an SMS reply with the sender phone number auto-inferred by the client. Supports parameter overrides for agent configuration.", "inputSchema": {
  to: {
    name: "Recipient Number",
    description: "Phone number to send the SMS reply to",
    validationSchema: /.*/,
...
var node16 = { "name": "Check Condition", "id": "checkcondition", "descripition": "Evaluates a condition comparing values with various operators, including AI-powered question answering", "inputSchema": {
  value: {
    name: "Value",
...
}, "groups": ["system", "Control Flow", "Logic"], "branches": { "match": { "name": "Match", "description": "Condition matched", "id": "match" }, "no_match": { "name": "No Match", "description": "Condition did not match", "id": "no_match" } }, "isTriggerNode": false, "cost": 0 };

// src/repeat_job.ts
var node17 = { "name": "Repeat Job", "id": "repeat_job", "descripition": "A description for RepeatJob", "inputSchema": {
  repeatType: {
    name: "Repeat Type",
...
}, "outputSchema": {}, "groups": ["system"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/run_another_workflow.ts
var node18 = { "name": "Run Another Workflow", "id": "run_another_workflow", "descripition": "A description for RunAnotherWorkflow", "inputSchema": {
  workflowCode: {
    name: "Workflow Code",
...
}, "outputSchema": {}, "groups": ["system", "Advanced"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/split_for_test.ts
var node19 = { "name": "Split For Test", "id": "split_for_test", "descripition": "Split workflow execution between testA and testB branches based on a ratio", "inputSchema": {
  splitRatio: {
...
}, "groups": ["system", "Control Flow"], "branches": { "test_a": { "id": "test_a", "name": "TestA", "description": "First branch of the split" }, "test_b": { "id": "test_b", "name": "TestB", "description": "Second branch of the split" } }, "isTriggerNode": false, "cost": 0 };

// src/waittime.ts
var node20 = { "name": "Wait Time", "id": "waittime", "descripition": "Pauses the workflow execution for a specified duration before proceeding to the next step", "inputSchema": {
  waitType: {
    name: "Wait Type",
...
}, "outputSchema": {}, "groups": ["system", "Control Flow", "Utility"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/on_outreachgenius_calendar_book_slot_called.ts
var node21 = { "name": "On Book Slot Called", "id": "on_outreachgenius_calendar_book_slot_called", "descripition": "Triggers when Book Slot is called via MCP API (Outreachgenius Calendar)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
...
}, "groups": ["Outreachgenius Calendar", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/on_outreachgenius_calendar_get_available_slots_called.ts
var node22 = { "name": "On Get Available Slots Called", "id": "on_outreachgenius_calendar_get_available_slots_called", "descripition": "Triggers when Get Available Slots is called via MCP API (Outreachgenius Calendar)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node23 = { "name": "Book Slot", "id": "outreachgenius_calendar_book_slot", "descripition": "Book a Cronofy calendar slot for an event", "inputSchema": {
  timezone: {
    name: "timezone",
...
var node24 = { "name": "Get Available Slots", "id": "outreachgenius_calendar_get_available_slots", "descripition": "Return available Cronofy slots for an eventId (mapped via project/zip if provided)", "inputSchema": {
  timezone: {
    name: "timezone",
    description: "Timezone",
    required: false,
...
// src/on_address_validation_api_get_geo_address_called.ts
var node26 = { "name": "On Get Geo Address Called", "id": "on_address_validation_api_get_geo_address_called", "descripition": "Triggers when Get Geo Address is called via MCP API (Address Validation API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["Address Validation API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/certapro_api_get_events.ts
var node27 = { "name": "Get Events", "id": "certapro_api_get_events", "descripition": 'Retrieves available calendar events/slots filtered by the configured filterName. Events are filtered to only show slots where the summary matches the filter (e.g., "ALL" for available slots).', "inputSchema": {
  zipCode: {
    name: "zipCode",
    description: "Zip code of the customer",
    required: false,
...
var node28 = { "name": "Update Event", "id": "certapro_api_update_event", "descripition": "Books/updates a calendar event with customer information. Takes an event_uid from the available slots and updates it with customer details.", "inputSchema": {
  notes: {
    name: "notes",
...
// src/on_certapro_api_get_events_called.ts
var node29 = { "name": "On Get Events Called", "id": "on_certapro_api_get_events_called", "descripition": "Triggers when Get Events is called via MCP API (CertaPro API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["CertaPro API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/on_certapro_api_update_event_called.ts
var node30 = { "name": "On Update Event Called", "id": "on_certapro_api_update_event_called", "descripition": "Triggers when Update Event is called via MCP API (CertaPro API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node31 = { "name": "Get Events", "id": "certapro_v2_api_get_events", "descripition": 'Retrieves available calendar events/slots filtered by the configured filterName. Events are filtered to only show slots where the summary matches the filter (e.g., "ALL" for available slots).', "inputSchema": {
  zipCode: {
    name: "zipCode",
    description: "Zip code of the customer",
    required: false,
...
var node32 = { "name": "Update Event", "id": "certapro_v2_api_update_event", "descripition": "Books/updates a calendar event with customer information. Takes an event_uid from the available slots and updates it with customer details.", "inputSchema": {
  notes: {
    name: "notes",
    description: "Additional notes",
    required: false,
...
// src/on_certapro_v2_api_get_events_called.ts
var node33 = { "name": "On Get Events Called", "id": "on_certapro_v2_api_get_events_called", "descripition": "Triggers when Get Events is called via MCP API (CertaPro V2 API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["CertaPro V2 API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/on_certapro_v2_api_update_event_called.ts
var node34 = { "name": "On Update Event Called", "id": "on_certapro_v2_api_update_event_called", "descripition": "Triggers when Update Event is called via MCP API (CertaPro V2 API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/certapro_v3_api_get_events.ts
var node35 = { "name": "Get Events", "id": "certapro_v3_api_get_events", "descripition": "Retrieves available calendar slots by finding teams matching the zip code and team type, then filtering each calendar's events using its configured filter rules.", "inputSchema": {
  teamType: {
    name: "teamType",
    ...
    parse: (value) => {
      try {
        return external_exports.any().parse(value);
      } catch (e) {
        return value;
      }
    }
...
}, "groups": ["CertaPro V3 API", "Get Events"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/certapro_v3_api_update_event.ts
var node36 = { "name": "Update Event", "id": "certapro_v3_api_update_event", "descripition": "Books/updates a calendar event with customer information. Takes an event_uid from the available slots and updates it with customer details.", "inputSchema": {
  notes: {
    name: "notes",
    description: "Additional notes",
    required: false,
...
}, "groups": ["CertaPro V3 API", "Update Event"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/on_certapro_v3_api_get_events_called.ts
var node37 = { "name": "On Get Events Called", "id": "on_certapro_v3_api_get_events_called", "descripition": "Triggers when Get Events is called via MCP API (CertaPro V3 API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["CertaPro V3 API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/on_certapro_v3_api_update_event_called.ts
var node38 = { "name": "On Update Event Called", "id": "on_certapro_v3_api_update_event_called", "descripition": "Triggers when Update Event is called via MCP API (CertaPro V3 API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node39 = { "name": "Forward To Agent", "id": "genesys_cloud_api_forward_to_agent", "descripition": "Forward the current call to a human agent. Automatically saves session data to Genesys and initiates conversation stitching.", "inputSchema": {
  summary: {
    name: "summary",
...
// src/genesys_cloud_api_get_appointment_slots.ts
var node40 = { "name": "Get Appointment Slots", "id": "genesys_cloud_api_get_appointment_slots", "descripition": "Retrieves available appointment slots from CertaPro by zip code. Returns a list of available time slots with human-readable date, day, and time information. Optionally filter to only show slots within the next N days.", "inputSchema": {
  numDays: {
    name: "numDays",
    ...
    parse: (value) => {
      try {
        return external_exports.coerce.number().parse(value);
      } catch (e) {
        return 0;
      }
    }
...
}, "groups": ["Genesys Cloud API", "Get Appointment Slots"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/genesys_cloud_api_submit_lead.ts
var node41 = { "name": "Submit Lead", "id": "genesys_cloud_api_submit_lead", "descripition": "Submits a new lead to CertaPro with customer information, job details, and selected appointment. Returns a confirmation number on success.", "inputSchema": {
  appointmentId: {
    name: "appointmentId",
...
}, "groups": ["Genesys Cloud API", "Submit Lead"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/on_genesys_cloud_api_forward_to_agent_called.ts
var node42 = { "name": "On Forward To Agent Called", "id": "on_genesys_cloud_api_forward_to_agent_called", "descripition": "Triggers when Forward To Agent is called via MCP API (Genesys Cloud API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["Genesys Cloud API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/on_genesys_cloud_api_get_appointment_slots_called.ts
var node43 = { "name": "On Get Appointment Slots Called", "id": "on_genesys_cloud_api_get_appointment_slots_called", "descripition": "Triggers when Get Appointment Slots is called via MCP API (Genesys Cloud API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
  ...
  numDays: {
    name: "numDays",
    description: "Input parameter: Number of days from now to include available slots (e.g. 7 for next 7 days)",
    example: 0,
    validator: (value) => true
  },
  zipCode: {
    name: "zipCode",
    description: "Input parameter: Zip code to search for available appointment slots",
    example: "",
    validator: (value) => true
  },
  result: {
...
// src/on_genesys_cloud_api_submit_lead_called.ts
var node44 = { "name": "On Submit Lead Called", "id": "on_genesys_cloud_api_submit_lead_called", "descripition": "Triggers when Submit Lead is called via MCP API (Genesys Cloud API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node45 = { "name": "Book Estimate", "id": "housecall_v1_api_book_estimate", "descripition": "Create and schedule an estimate with required last name, free estimate line item, bookable employees, and call summary note.", "inputSchema": {
  callSummary: {
    name: "call_summary",
...
var node46 = { "name": "Find Or Create Customer", "id": "housecall_v1_api_find_or_create_customer", "descripition": "Lookup by phone and create if not found (returns the single customer record).", "inputSchema": {
  lastName: {
    name: "last_name",
...
var node47 = { "name": "Get Customer", "id": "housecall_v1_api_get_customer", "descripition": "Retrieve a customer by ID from Housecall.", "inputSchema": {
  id: {
    name: "id",
...
var node48 = { "name": "List Available Estimate Slots", "id": "housecall_v1_api_list_available_estimate_slots", "descripition": "Return available estimate slots for the given date with bookable employees.", "inputSchema": {
  date: {
    name: "date",
...
var node49 = { "name": "Search Customers By Phone", "id": "housecall_v1_api_search_customers_by_phone", "descripition": "Find existing customers using a phone number provided during the call.", "inputSchema": {
  phone: {
    name: "phone",
...
// src/on_housecall_v1_api_book_estimate_called.ts
var node50 = { "name": "On Book Estimate Called", "id": "on_housecall_v1_api_book_estimate_called", "descripition": "Triggers when Book Estimate is called via MCP API (Housecall v1 API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["Housecall v1 API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/on_housecall_v1_api_find_or_create_customer_called.ts
var node51 = { "name": "On Find Or Create Customer Called", "id": "on_housecall_v1_api_find_or_create_customer_called", "descripition": "Triggers when Find Or Create Customer is called via MCP API (Housecall v1 API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_housecall_v1_api_get_customer_called.ts
var node52 = { "name": "On Get Customer Called", "id": "on_housecall_v1_api_get_customer_called", "descripition": "Triggers when Get Customer is called via MCP API (Housecall v1 API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_housecall_v1_api_list_available_estimate_slots_called.ts
var node53 = { "name": "On List Available Estimate Slots Called", "id": "on_housecall_v1_api_list_available_estimate_slots_called", "descripition": "Triggers when List Available Estimate Slots is called via MCP API (Housecall v1 API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_housecall_v1_api_search_customers_by_phone_called.ts
var node54 = { "name": "On Search Customers By Phone Called", "id": "on_housecall_v1_api_search_customers_by_phone_called", "descripition": "Triggers when Search Customers By Phone is called via MCP API (Housecall v1 API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node55 = { "name": "Book Meeting Slot", "id": "hubspot_crm_api_book_meeting_slot", "descripition": "Book a meeting using a time slot ID from the availability results.", "inputSchema": {
  locale: {
    name: "locale",
...
var node56 = { "name": "Create Contact", "id": "hubspot_crm_api_create_contact", "descripition": "Create a new contact in HubSpot CRM with contact information.", "inputSchema": {
  jobtitle: {
    name: "jobtitle",
...
var node57 = { "name": "Create Note", "id": "hubspot_crm_api_create_note", "descripition": "Create a note in HubSpot and associate it with contacts.", "inputSchema": {
  contactIds: {
    name: "contactIds",
    ...
    parse: (value) => {
      try {
        return external_exports.array(external_exports.any()).parse(value);
      } catch (e) {
        return [];
      }
    }
...
var node58 = { "name": "Get Available Time Slots", "id": "hubspot_crm_api_get_available_time_slots", "descripition": "Get human-readable available time slots for booking meetings.", "inputSchema": {
  days: {
    name: "days",
...
var node59 = { "name": "Get Contact", "id": "hubspot_crm_api_get_contact", "descripition": "Retrieve a contact by ID or email from HubSpot.", "inputSchema": {
  email: {
    name: "email",
    description: "Contact's email address",
    required: false,
...
var node60 = { "name": "Get Meeting Booking Info", "id": "hubspot_crm_api_get_meeting_booking_info", "descripition": "Get booking information and availability for a meeting link.", "inputSchema": {
  monthOffset: {
    name: "monthOffset",
...
var node61 = { "name": "Search Contacts", "id": "hubspot_crm_api_search_contacts", "descripition": "Search for contacts in HubSpot using various criteria.", "inputSchema": {
  limit: {
    name: "limit",
...
var node62 = { "name": "Test Connection", "id": "hubspot_crm_api_test_connection", "descripition": "Test the HubSpot API connection and authentication.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
// src/on_hubspot_crm_api_book_meeting_slot_called.ts
var node63 = { "name": "On Book Meeting Slot Called", "id": "on_hubspot_crm_api_book_meeting_slot_called", "descripition": "Triggers when Book Meeting Slot is called via MCP API (HubSpot CRM API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["HubSpot CRM API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/on_hubspot_crm_api_create_contact_called.ts
var node64 = { "name": "On Create Contact Called", "id": "on_hubspot_crm_api_create_contact_called", "descripition": "Triggers when Create Contact is called via MCP API (HubSpot CRM API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_hubspot_crm_api_create_note_called.ts
var node65 = { "name": "On Create Note Called", "id": "on_hubspot_crm_api_create_note_called", "descripition": "Triggers when Create Note is called via MCP API (HubSpot CRM API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_hubspot_crm_api_get_available_time_slots_called.ts
var node66 = { "name": "On Get Available Time Slots Called", "id": "on_hubspot_crm_api_get_available_time_slots_called", "descripition": "Triggers when Get Available Time Slots is called via MCP API (HubSpot CRM API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_hubspot_crm_api_get_contact_called.ts
var node67 = { "name": "On Get Contact Called", "id": "on_hubspot_crm_api_get_contact_called", "descripition": "Triggers when Get Contact is called via MCP API (HubSpot CRM API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_hubspot_crm_api_get_meeting_booking_info_called.ts
var node68 = { "name": "On Get Meeting Booking Info Called", "id": "on_hubspot_crm_api_get_meeting_booking_info_called", "descripition": "Triggers when Get Meeting Booking Info is called via MCP API (HubSpot CRM API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_hubspot_crm_api_search_contacts_called.ts
var node69 = { "name": "On Search Contacts Called", "id": "on_hubspot_crm_api_search_contacts_called", "descripition": "Triggers when Search Contacts is called via MCP API (HubSpot CRM API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_hubspot_crm_api_test_connection_called.ts
var node70 = { "name": "On Test Connection Called", "id": "on_hubspot_crm_api_test_connection_called", "descripition": "Triggers when Test Connection is called via MCP API (HubSpot CRM API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_public_holiday_api_holiday_check_v1_called.ts
var node72 = { "name": "On holiday-check-v1 Called", "id": "on_public_holiday_api_holiday_check_v1_called", "descripition": "Triggers when holiday-check-v1 is called via MCP API (Public Holiday API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["Public Holiday API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/sample_api_sample_tool.ts
var node73 = { "name": "Sample Tool", "id": "sample_api_sample_tool", "descripition": "This is a sample tool within the Sample API.", "inputSchema": {
  param1: {
    name: "param1",
...
// src/on_sample_api_sample_tool_called.ts
var node74 = { "name": "On Sample Tool Called", "id": "on_sample_api_sample_tool_called", "descripition": "Triggers when Sample Tool is called via MCP API (Sample API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["Sample API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/sample_api_counter_tool.ts
var node75 = { "name": "Counter Tool", "id": "sample_api_counter_tool", "descripition": "This tool increments a counter stored in the session.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
// src/on_sample_api_counter_tool_called.ts
var node76 = { "name": "On Counter Tool Called", "id": "on_sample_api_counter_tool_called", "descripition": "Triggers when Counter Tool is called via MCP API (Sample API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node77 = { "name": "Locate Contact", "id": "serviceminder_api_locate_contact", "descripition": "Search for existing contacts by name, phone, email, or address. Essential for identifying callers.", "inputSchema": {
  limit: {
    name: "limit",
...
// src/on_serviceminder_api_locate_contact_called.ts
var node78 = { "name": "On Locate Contact Called", "id": "on_serviceminder_api_locate_contact_called", "descripition": "Triggers when Locate Contact is called via MCP API (ServiceMinder API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["ServiceMinder API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/serviceminder_api_add_or_update_contact.ts
var node79 = { "name": "Add or Update Contact", "id": "serviceminder_api_add_or_update_contact", "descripition": "Create a new contact or update existing one. Use when customer information needs to be added or modified.", "inputSchema": {
  campaign: {
    name: "campaign",
...
// src/on_serviceminder_api_add_or_update_contact_called.ts
var node80 = { "name": "On Add or Update Contact Called", "id": "on_serviceminder_api_add_or_update_contact_called", "descripition": "Triggers when Add or Update Contact is called via MCP API (ServiceMinder API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node81 = { "name": "Add Note to Contact", "id": "serviceminder_api_add_note_to_contact", "descripition": "Add a note to a customer's record. Useful for call logs and follow-up information.", "inputSchema": {
  noteBody: {
    name: "noteBody",
    description: "Content of the note",
    required: true,
...
// src/on_serviceminder_api_add_note_to_contact_called.ts
var node82 = { "name": "On Add Note to Contact Called", "id": "on_serviceminder_api_add_note_to_contact_called", "descripition": "Triggers when Add Note to Contact is called via MCP API (ServiceMinder API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node83 = { "name": "Search Available Slots", "id": "serviceminder_api_search_available_slots", "descripition": "Find available appointment slots for scheduling. Essential for booking appointments.", "inputSchema": {
  slotWindowDays: {
    name: "slotWindowDays",
...
// src/on_serviceminder_api_search_available_slots_called.ts
var node84 = { "name": "On Search Available Slots Called", "id": "on_serviceminder_api_search_available_slots_called", "descripition": "Triggers when Search Available Slots is called via MCP API (ServiceMinder API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node85 = { "name": "Book Appointment", "id": "serviceminder_api_book_appointment", "descripition": "Book a confirmed appointment for a customer. Use after finding available slots.", "inputSchema": {
  quantity: {
    name: "quantity",
...
// src/on_serviceminder_api_book_appointment_called.ts
var node86 = { "name": "On Book Appointment Called", "id": "on_serviceminder_api_book_appointment_called", "descripition": "Triggers when Book Appointment is called via MCP API (ServiceMinder API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node87 = { "name": "Log Call", "id": "serviceminder_api_log_call", "descripition": "Log details of a phone call interaction.", "inputSchema": {
  callDetails: {
    name: "callDetails",
...
// src/on_serviceminder_api_log_call_called.ts
var node88 = { "name": "On Log Call Called", "id": "on_serviceminder_api_log_call_called", "descripition": "Triggers when Log Call is called via MCP API (ServiceMinder API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node89 = { "name": "Get Job", "id": "psa_api_get_job", "descripition": "Retrieve job details by ID from PSA system.", "inputSchema": {
  jobId: {
    name: "jobId",
...
// src/on_psa_api_get_job_called.ts
var node90 = { "name": "On Get Job Called", "id": "on_psa_api_get_job_called", "descripition": "Triggers when Get Job is called via MCP API (PSA API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
  ...
  jobId: {
    name: "jobId",
    description: "Input parameter: The ID of the job to retrieve",
    example: 0,
    validator: (value) => true
  },
  result: {
...
}, "groups": ["PSA API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/psa_api_get_company.ts
var node91 = { "name": "Get Company", "id": "psa_api_get_company", "descripition": "Retrieve company details by ID from PSA system.", "inputSchema": {
  companyId: {
    name: "companyId",
...
// src/on_psa_api_get_company_called.ts
var node92 = { "name": "On Get Company Called", "id": "on_psa_api_get_company_called", "descripition": "Triggers when Get Company is called via MCP API (PSA API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node93 = { "name": "Get Contact", "id": "psa_api_get_contact", "descripition": "Retrieve contact details by ID from PSA system.", "inputSchema": {
  contactId: {
    name: "contactId",
...
// src/on_psa_api_get_contact_called.ts
var node94 = { "name": "On Get Contact Called", "id": "on_psa_api_get_contact_called", "descripition": "Triggers when Get Contact is called via MCP API (PSA API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
  ...
  contactId: {
    name: "contactId",
    description: "Input parameter: The ID of the contact to retrieve",
    example: 0,
    validator: (value) => true
  },
  result: {
...
var node95 = { "name": "Add Company", "id": "psa_api_add_company", "descripition": "Create a new company in PSA system with primary site and optional contact info.", "inputSchema": {
  phone: {
    name: "phone",
    description: "Phone number",
    required: false,
...
// src/on_psa_api_add_company_called.ts
var node96 = { "name": "On Add Company Called", "id": "on_psa_api_add_company_called", "descripition": "Triggers when Add Company is called via MCP API (PSA API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node97 = { "name": "Add Contact", "id": "psa_api_add_contact", "descripition": "Create a new contact in PSA system associated with the configured company.", "inputSchema": {
  phone: {
    name: "phone",
...
// src/on_psa_api_add_contact_called.ts
var node98 = { "name": "On Add Contact Called", "id": "on_psa_api_add_contact_called", "descripition": "Triggers when Add Contact is called via MCP API (PSA API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node99 = { "name": "Add Job", "id": "psa_api_add_job", "descripition": "Create a new job in PSA system. Only name is required.", "inputSchema": {
  siteName: {
    name: "siteName",
    description: "Site name",
    required: false,
...
// src/on_psa_api_add_job_called.ts
var node100 = { "name": "On Add Job Called", "id": "on_psa_api_add_job_called", "descripition": "Triggers when Add Job is called via MCP API (PSA API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node101 = { "name": "Get Campaigns", "id": "servicetitan_api_get_campaigns", "descripition": "Retrieves all active campaigns from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
// src/on_servicetitan_api_get_campaigns_called.ts
var node102 = { "name": "On Get Campaigns Called", "id": "on_servicetitan_api_get_campaigns_called", "descripition": "Triggers when Get Campaigns is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["ServiceTitan API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/servicetitan_api_get_business_units.ts
var node103 = { "name": "Get Business Units", "id": "servicetitan_api_get_business_units", "descripition": "Retrieves all active business units from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
// src/on_servicetitan_api_get_business_units_called.ts
var node104 = { "name": "On Get Business Units Called", "id": "on_servicetitan_api_get_business_units_called", "descripition": "Triggers when Get Business Units is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node105 = { "name": "Get Job Types", "id": "servicetitan_api_get_job_types", "descripition": "Retrieves all active job types from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
// src/on_servicetitan_api_get_job_types_called.ts
var node106 = { "name": "On Get Job Types Called", "id": "on_servicetitan_api_get_job_types_called", "descripition": "Triggers when Get Job Types is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node107 = { "name": "Get Geo Address", "id": "servicetitan_api_get_geo_address", "descripition": "Geocodes an address using Google Maps Geocoding API. Takes a street address or ZIP code and returns geocoded address suggestions. Uses optional city, state, and country MCP properties to streamline search when provided.", "inputSchema": {
  street: {
    name: "street",
    description: "Street address or ZIP code to geocode.",
    required: true,
...
// src/on_servicetitan_api_get_geo_address_called.ts
var node108 = { "name": "On Get Geo Address Called", "id": "on_servicetitan_api_get_geo_address_called", "descripition": "Triggers when Get Geo Address is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node109 = { "name": "Get Customer by Phone", "id": "servicetitan_api_get_customer_by_phone", "descripition": "Retrieves customer information from ServiceTitan by phone number.", "inputSchema": {
  phone: {
    name: "phone",
...
// src/on_servicetitan_api_get_customer_by_phone_called.ts
var node110 = { "name": "On Get Customer by Phone Called", "id": "on_servicetitan_api_get_customer_by_phone_called", "descripition": "Triggers when Get Customer by Phone is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
  ...
  phone: {
    name: "phone",
    description: "Input parameter: The customer's phone number.",
    example: "",
    validator: (value) => true
  },
  result: {
...
var node111 = { "name": "Get Customer Locations", "id": "servicetitan_api_get_customer_locations", "descripition": "Retrieves location information for a customer from ServiceTitan by customer ID.", "inputSchema": {
  customerId: {
    name: "customerId",
...
// src/on_servicetitan_api_get_customer_locations_called.ts
var node112 = { "name": "On Get Customer Locations Called", "id": "on_servicetitan_api_get_customer_locations_called", "descripition": "Triggers when Get Customer Locations is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
  ...
  customerId: {
    name: "customerId",
    description: "Input parameter: The customer's ID.",
    example: 0,
    validator: (value) => true
  },
  result: {
...
var node113 = { "name": "Create Customer", "id": "servicetitan_api_create_customer", "descripition": "Creates a new customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
  ...
  address: {
    ...
    parse: (value) => {
      try {
        return external_exports.record(external_exports.any()).parse(value);
      } catch (e) {
        return {};
      }
    }
...
// src/on_servicetitan_api_create_customer_called.ts
var node114 = { "name": "On Create Customer Called", "id": "on_servicetitan_api_create_customer_called", "descripition": "Triggers when Create Customer is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node115 = { "name": "Update Customer", "id": "servicetitan_api_update_customer", "descripition": "Updates an existing customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
    description: "Array of contact objects (optional).",
    required: false,
...
// src/on_servicetitan_api_update_customer_called.ts
var node116 = { "name": "On Update Customer Called", "id": "on_servicetitan_api_update_customer_called", "descripition": "Triggers when Update Customer is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node117 = { "name": "Create Customer Location", "id": "servicetitan_api_create_customer_location", "descripition": "Creates a new location for a customer in ServiceTitan.", "inputSchema": {
  name: {
    name: "name",
...
// src/on_servicetitan_api_create_customer_location_called.ts
var node118 = { "name": "On Create Customer Location Called", "id": "on_servicetitan_api_create_customer_location_called", "descripition": "Triggers when Create Customer Location is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_servicetitan_api_create_job_for_new_customer_called.ts
var node120 = { "name": "On Create Job for New Customer Called", "id": "on_servicetitan_api_create_job_for_new_customer_called", "descripition": "Triggers when Create Job for New Customer is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_servicetitan_api_create_job_for_existing_customer_called.ts
var node122 = { "name": "On Create Job for Existing Customer Called", "id": "on_servicetitan_api_create_job_for_existing_customer_called", "descripition": "Triggers when Create Job for Existing Customer is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_servicetitan_api_get_jobs_by_customer_called.ts
var node124 = { "name": "On Get Jobs by Customer Called", "id": "on_servicetitan_api_get_jobs_by_customer_called", "descripition": "Triggers when Get Jobs by Customer is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node125 = { "name": "Update Job", "id": "servicetitan_api_update_job", "descripition": "Updates an existing job in ServiceTitan.", "inputSchema": {
  appointments: {
    name: "appointments",
...
// src/on_servicetitan_api_update_job_called.ts
var node126 = { "name": "On Update Job Called", "id": "on_servicetitan_api_update_job_called", "descripition": "Triggers when Update Job is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node127 = { "name": "Get Available Technicians", "id": "servicetitan_api_get_available_technicians", "descripition": "Retrieves both regular available technicians with their free time slots AND the on-call technicians (current and upcoming shifts) for a specific date.", "inputSchema": {
  summary: {
    name: "summary",
...
// src/on_servicetitan_api_get_available_technicians_called.ts
var node128 = { "name": "On Get Available Technicians Called", "id": "on_servicetitan_api_get_available_technicians_called", "descripition": "Triggers when Get Available Technicians is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node129 = { "name": "Get Active Technicians", "id": "servicetitan_api_get_active_technicians", "descripition": "Retrieves all active technicians from ServiceTitan Settings API.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
// src/on_servicetitan_api_get_active_technicians_called.ts
var node130 = { "name": "On Get Active Technicians Called", "id": "on_servicetitan_api_get_active_technicians_called", "descripition": "Triggers when Get Active Technicians is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node131 = { "name": "Get Appointments", "id": "servicetitan_api_get_appointments", "descripition": "Retrieves appointments for a specific job.", "inputSchema": {
  jobId: {
    name: "jobId",
...
// src/on_servicetitan_api_get_appointments_called.ts
var node132 = { "name": "On Get Appointments Called", "id": "on_servicetitan_api_get_appointments_called", "descripition": "Triggers when Get Appointments is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
  ...
  jobId: {
    name: "jobId",
    description: "Input parameter: The job ID.",
    example: 0,
    validator: (value) => true
  },
  result: {
...
var node133 = { "name": "Reschedule Appointment", "id": "servicetitan_api_reschedule_appointment", "descripition": "Reschedules an existing appointment in ServiceTitan.", "inputSchema": {
  arrivalWindowEnd: {
...
// src/on_servicetitan_api_reschedule_appointment_called.ts
var node134 = { "name": "On Reschedule Appointment Called", "id": "on_servicetitan_api_reschedule_appointment_called", "descripition": "Triggers when Reschedule Appointment is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
  ...
  arrivalWindowEnd: {
    name: "arrivalWindowEnd",
    description: "Input parameter: New arrival window end time (optional).",
    example: "",
    validator: (value) => true
  },
  arrivalWindowStart: {
    name: "arrivalWindowStart",
    description: "Input parameter: New arrival window start time (optional).",
    example: "",
    validator: (value) => true
  },
  end: {
    name: "end",
    description: "Input parameter: New appointment end time in ISO 8601 format (optional).",
    example: "",
    validator: (value) => true
  },
  start: {
    name: "start",
    description: "Input parameter: New appointment start time in ISO 8601 format (optional).",
    example: "",
    validator: (value) => true
  },
  appointmentId: {
    name: "appointmentId",
    description: "Input parameter: The appointment ID to reschedule.",
    example: 0,
    validator: (value) => true
  },
  result: {
...
var node135 = { "name": "Update Location Contact", "id": "servicetitan_api_update_location_contact", "descripition": "Updates contact details (email and/or phone) for a location.", "inputSchema": {
  phone: {
    name: "phone",
...
// src/on_servicetitan_api_update_location_contact_called.ts
var node136 = { "name": "On Update Location Contact Called", "id": "on_servicetitan_api_update_location_contact_called", "descripition": "Triggers when Update Location Contact is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
  ...
  locationId: {
    name: "locationId",
    description: "Input parameter: The location ID.",
    example: 0,
    validator: (value) => true
  },
  result: {
...
var node137 = { "name": "Update Customer Contact", "id": "servicetitan_api_update_customer_contact", "descripition": "Updates contact details (email and/or phone) for a customer.", "inputSchema": {
  phone: {
    name: "phone",
    description: "New phone number (optional).",
    required: false,
...
// src/on_servicetitan_api_update_customer_contact_called.ts
var node138 = { "name": "On Update Customer Contact Called", "id": "on_servicetitan_api_update_customer_contact_called", "descripition": "Triggers when Update Customer Contact is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node139 = { "name": "Get Cancellation Reasons", "id": "servicetitan_api_get_cancellation_reasons", "descripition": "Retrieves all available job cancellation reasons.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
// src/on_servicetitan_api_get_cancellation_reasons_called.ts
var node140 = { "name": "On Get Cancellation Reasons Called", "id": "on_servicetitan_api_get_cancellation_reasons_called", "descripition": "Triggers when Get Cancellation Reasons is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_servicetitan_api_cancel_job_called.ts
var node142 = { "name": "On Cancel Job Called", "id": "on_servicetitan_api_cancel_job_called", "descripition": "Triggers when Cancel Job is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node143 = { "name": "Update Customer Details", "id": "servicetitan_api_update_customer_details", "descripition": "Updates comprehensive customer details including name, type, address, and tags.", "inputSchema": {
  tagTypeIds: {
    name: "tagTypeIds",
...
// src/on_servicetitan_api_update_customer_details_called.ts
var node144 = { "name": "On Update Customer Details Called", "id": "on_servicetitan_api_update_customer_details_called", "descripition": "Triggers when Update Customer Details is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
var node145 = { "name": "Add Call Summary Note", "id": "servicetitan_api_add_call_summary_note", "descripition": "Adds a call summary note to a job by appending to the existing job summary. Includes timestamp and formatted call details.", "inputSchema": {
  additionalDetails: {
...
// src/on_servicetitan_api_add_call_summary_note_called.ts
var node146 = { "name": "On Add Call Summary Note Called", "id": "on_servicetitan_api_add_call_summary_note_called", "descripition": "Triggers when Add Call Summary Note is called via MCP API (ServiceTitan API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["YouCanBookMe API", "Get Available Slots"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/on_youcanbookme_api_get_available_slots_called.ts
var node148 = { "name": "On Get Available Slots Called", "id": "on_youcanbookme_api_get_available_slots_called", "descripition": "Triggers when Get Available Slots is called via MCP API (YouCanBookMe API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["YouCanBookMe API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/youcanbookme_api_book_slot.ts
var node149 = { "name": "Book Slot", "id": "youcanbookme_api_book_slot", "descripition": "Books the chosen slot on the YouCanBookMe page. Creates a real confirmed booking. Pass the 'startsAt' value exactly as returned by getAvailableSlots. Fields marked COMPULSORY must be collected from the customer before calling.", "inputSchema": {
  dealId: {
    name: "dealId",
    description: "OPTIONAL. CRM Deal ID to attach to the booking. \u2192 YCBM 'Deal ID' (DEAL_ID). Omitted when not provided.",
    required: false,
    validationSchema: /.*/,
    errorMessage: "",
    input: { type: "text" },
...
}, "groups": ["YouCanBookMe API", "Book Slot"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/on_youcanbookme_api_book_slot_called.ts
var node150 = { "name": "On Book Slot Called", "id": "on_youcanbookme_api_book_slot_called", "descripition": "Triggers when Book Slot is called via MCP API (YouCanBookMe API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/on_you_can_book_me_api_book_called.ts
var node151 = { "name": "On Book Called", "id": "on_you_can_book_me_api_book_called", "descripition": "Triggers when Book is called via MCP API (You Can Book Me API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
}, "groups": ["You Can Book Me API", "Triggers", "MCP"], "branches": { "success": { "id": "success", "name": "Success", "description": "Tool call completed successfully" }, "failure": { "id": "failure", "name": "Failure", "description": "Tool call failed with an error" } }, "isTriggerNode": true, "cost": 0 };

// src/on_you_can_book_me_api_get_events_called.ts
var node152 = { "name": "On Get Events Called", "id": "on_you_can_book_me_api_get_events_called", "descripition": "Triggers when Get Events is called via MCP API (You Can Book Me API)", "inputSchema": {}, "outputSchema": {
  callerPhone: {
    name: "Caller Phone",
    description: "Phone number of the caller (from MCP session)",
    example: "+14155552671",
...
// src/you_can_book_me_api_book.ts
var node153 = { "name": "Book", "id": "you_can_book_me_api_book", "descripition": "Books a calendar event at the chosen start time on the first residential calendar whose team tags overlap the provided tags. Trusts the caller's chosen time without re-checking availability.", "inputSchema": {
  notes: {
    name: "notes",
    description: "Additional notes",
    required: false,
...
}, "groups": ["You Can Book Me API", "Book"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/you_can_book_me_api_get_events.ts
var node154 = { "name": "Get Events", "id": "you_can_book_me_api_get_events", "descripition": "Returns available booking slots over the next 14 days for residential calendars whose team tags overlap any of the provided tags. Tag matching is exact and any-match.", "inputSchema": {
  tags: {
    name: "tags",
...
}, "groups": ["You Can Book Me API", "Get Events"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/add_tag_to_lead.ts
var node155 = { "name": "Add Tag To Lead (Deprecated)", "id": "add_tag_to_lead", "descripition": "Assigns a specified tag to a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
...
}, "outputSchema": {}, "groups": ["system", "Lead Management", "Tags"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/add_tag_to_lead_v2.ts
var node156 = { "name": "Add Tag To Lead V2", "id": "add_tag_to_lead_v2", "descripition": "Assigns a specified tag to a lead identified by email or phone number, with a tag dropdown selector", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
var node157 = { "name": "Check If Invoice Overdue", "id": "check_if_invoice_overdue", "descripition": "A description for CheckIfInvoiceOverdue", "inputSchema": {
  invoiceId: {
    name: "Invoice ID",
...
}, "groups": ["system", "Lead Generation", "Data Enrichment", "Trigger"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/get_tags.ts
var node159 = { "name": "Get Tags", "id": "get_tags", "descripition": "Retrieves all tags associated with a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
}, "groups": ["system", "Data", "Lead Management", "Tags"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/remove_tag_from_lead.ts
var node160 = { "name": "Remove Tag From Lead (Deprecated)", "id": "remove_tag_from_lead", "descripition": "Removes a specified tag from a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
// src/remove_tag_from_lead_v2.ts
var node161 = { "name": "Remove Tag From Lead V2", "id": "remove_tag_from_lead_v2", "descripition": "Removes a specified tag from a lead identified by email or phone number, with a tag dropdown selector", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
var node162 = { "name": "Add Note To Lead Service Titan", "id": "add_note_to_lead_service_titan", "descripition": "Adds a note to a lead in ServiceTitan", "inputSchema": {
  leadId: {
    name: "Lead ID",
...
}, "outputSchema": {}, "groups": ["system", "ServiceTitan", "Notes"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/apply_tag_service_titan.ts
var node163 = { "name": "Apply Tag Service Titan", "id": "apply_tag_service_titan", "descripition": "Applies a tag to a customer in ServiceTitan", "inputSchema": {
  tagTypeId: {
...
}, "outputSchema": {}, "groups": ["system", "ServiceTitan", "Tags"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/check_job_status_service_titan.ts
var node164 = { "name": "Check Job Status Service Titan", "id": "check_job_status_service_titan", "descripition": "Checks the status of a job in ServiceTitan; branches by job status, or to 'error' if the check fails", "inputSchema": {
  job_id: {
    name: "Job ID",
...
}, "groups": ["system", "ServiceTitan", "Leads"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_service_titan_recurring_service_estimates.ts
var node166 = { "name": "Get Service Titan Recurring Service Estimates", "id": "get_service_titan_recurring_service_estimates", "descripition": "A description for GetServiceTitanRecurringServiceEstimates", "inputSchema": {}, "outputSchema": {}, "groups": ["system", "ServiceTitan"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_service_titan_accounts_receievables.ts
var node167 = { "name": "Get Service Titan Unpaid Invoices", "id": "get_service_titan_accounts_receievables", "descripition": "Retrieves unpaid invoices from ServiceTitan that are past a specified number of days due.", "inputSchema": {
  daysPastDue: {
    name: "Days Past Due",
...
}, "groups": ["system", "ServiceTitan"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/get_unassigned_recurring_events.ts
var node168 = { "name": "Get Unassigned Recurring Events", "id": "get_unassigned_recurring_events", "descripition": "A description for GetUnassignedRecurringServiceEvents", "inputSchema": {
  nextNDays: {
    name: "Next N Days",
...
}, "groups": ["system"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/service_titan_technicion_sms.ts
var node169 = { "name": "Service Titan Technicion Sms", "id": "service_titan_technicion_sms", "descripition": "This will trigger sending sms and follow up call to the technicion", "inputSchema": {}, "outputSchema": {
  job_id: {
    name: "Job ID",
...
var node170 = { "name": "Custom Webhook", "id": "custom_webhook", "descripition": "Makes custom HTTP requests to external APIs with configurable methods, headers, and body content", "inputSchema": {
  url: {
    name: "URL",
...
}, "groups": ["system", "HTTP", "Integration"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_uploaded_leads_trigger.ts
var node171 = { "name": "Get Uploaded Leads Trigger", "id": "get_uploaded_leads_trigger", "descripition": "Triggers a workflow when new leads are uploaded, with options for scheduling and limiting the number of leads", "inputSchema": {
  numLeadsToFetch: {
...
}, "groups": ["system", "Triggers", "Data", "Lead Management"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/inbound_call_trigger.ts
var node172 = { "name": "Inbound Call Trigger", "id": "inbound_call_trigger", "descripition": "Triggers a workflow when an inbound call is received, providing caller details and call transcription", "inputSchema": {}, "outputSchema": {
  phone: {
    name: "Phone Number",
...
}, "groups": ["system", "Triggers", "Communication", "Phone"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/manual_trigger.ts
var node173 = { "name": "Manual Trigger", "id": "manual_trigger", "descripition": "A description for ManualTrigger", "inputSchema": {}, "outputSchema": {
  phone: {
    name: "Phone Number",
    description: "The phone number to send notifications to",
    required: false,
...
}, "groups": ["system", "Advanced", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_email_received.ts
var node174 = { "name": "Email Received", "id": "on_email_received", "descripition": "Triggers when a new email is received in the connected email account.\n It automatically extracts key information like lead's name, email, phone number, and any other fields present in the email body.", "inputSchema": {}, "outputSchema": {
  from: {
    name: "From",
...
var node175 = { "name": "ServiceTitan New Appoinment", "id": "on_new_appoinment_service_titan", "descripition": "Triggers when a new appointment is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
}, "groups": ["system", "ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_new_call_service_titan.ts
var node176 = { "name": "ServiceTitan New Call", "id": "on_new_call_service_titan", "descripition": "Triggers when a new call is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  createdOn: {
    name: "Created On",
...
var node177 = { "name": "ServiceTitan New Customer", "id": "on_new_customer_service_titan", "descripition": "Triggers when a new customer is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The unique identifier for the customer",
    example: 12345,
...
var node178 = { "name": "ServiceTitan New Estimate", "id": "on_new_estimate_service_titan", "descripition": "Triggers when a new estimate is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node179 = { "name": "ServiceTitan New Invoice", "id": "on_new_invoice_service_titan", "descripition": "Triggers when a new invoice is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node180 = { "name": "ServiceTitan New Job Or Project Note", "id": "on_new_job_or_project_note_service_titan", "descripition": "Triggers when a new note is added to a job or project in ServiceTitan", "inputSchema": {
  entityType: {
    name: "Note Type",
...
var node181 = { "name": "ServiceTitan New Job", "id": "on_new_job_service_titan", "descripition": "Triggers when a new job is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The job ID",
    example: 12345,
...
var node182 = { "name": "ServiceTitan New Lead Note", "id": "on_new_lead_note_service_titan", "descripition": "Triggers when a new note is added to a lead in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node183 = { "name": "ServiceTitan New Lead", "id": "on_new_lead_service_titan", "descripition": "Triggers when a new lead is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The ID of the lead",
    example: 123,
...
var node184 = { "name": "ServiceTitan New Payment", "id": "on_new_payment_service_titan", "descripition": "Triggers when a new payment is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node185 = { "name": "ServiceTitan New Project", "id": "on_new_project_service_titan", "descripition": "Triggers when a new project is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node186 = { "name": "On SMS Received", "id": "on_s_m_s_received", "descripition": "A description for OnSMSReceived", "inputSchema": {}, "outputSchema": {
  customerNumber: {
...
// src/on_tag_added.ts
var node187 = { "name": "On Tag Added", "id": "on_tag_added", "descripition": "Triggers a workflow when a tag is added to a lead, providing lead information", "inputSchema": {}, "outputSchema": {
  tag: {
    name: "Tag",
...
}, "groups": ["system", "Triggers", "Lead Management", "Tags"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_updated_call_service_titan.ts
var node188 = { "name": "ServiceTitan Updated Call", "id": "on_updated_call_service_titan", "descripition": "Triggers when a call is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["system", "ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_updated_estimate_service_titan.ts
var node189 = { "name": "ServiceTitan Updated Estimate", "id": "on_updated_estimate_service_titan", "descripition": "Triggers when an estimate is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["system", "ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_website_vistor_indentified.ts
var node190 = { "name": "On Website Visitor Identified", "id": "on_website_vistor_indentified", "descripition": "Triggers when an anonymous Website visitor is identified via our Pixel Tag", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
...
}, "groups": ["system", "Trigger", "Website"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/run_once_trigger.ts
var node191 = { "name": "Run Once", "id": "run_once_trigger", "descripition": "A trigger node that runs only once when the workflow is activated", "inputSchema": {}, "outputSchema": {}, "groups": ["system", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/webhook_trigger.ts
var node192 = { "name": "Webhook", "id": "webhook_trigger", "descripition": "Starts a workflow when data is received from an external webhook, extracting contact information", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
...
}, "groups": ["system", "Triggers", "Integration"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/is_public_holiday.ts
var node193 = { "name": "Is Public Holiday", "id": "is_public_holiday", "descripition": "Check if current date is a public holiday in the US", "inputSchema": {
  holidays: {
    name: "Holidays",
...
}, "groups": ["system"], "branches": { "match": { "name": "Match", "description": "Condition matched", "id": "match" }, "no_match": { "name": "No Match", "description": "Condition did not match", "id": "no_match" } }, "isTriggerNode": false, "cost": 0 };

// src/extract_common_field.ts
var node194 = { "name": "Extract Common Field", "id": "extract_common_field", "descripition": "Extracts common fields like date, email, or phone number from text using predefined patterns.", "inputSchema": {
  rawText: {
    name: "Raw Text",
...
}, "groups": ["system", "Data"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/extract_with_a_i.ts
var node195 = { "name": "Extract With AI", "id": "extract_with_a_i", "descripition": "Extracts specific information from text using AI analysis based on provided instructions", "inputSchema": {
  rawText: {
    name: "Raw Text",
    description: "The text to extract information from",
    validationSchema: /.*/,
...
}, "groups": ["system", "Data", "AI"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_constant.ts
var node196 = { "name": "Get Constant", "id": "get_constant", "descripition": "Returns various useful constants like time information, system values, and random data", "inputSchema": {
  constantType: {
    name: "Constant Type",
...
}, "groups": ["system", "Utilities"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_variable.ts
var node197 = { "name": "Get Variable", "id": "get_variable", "descripition": "Gets the value of a stored variable", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
...
}, "groups": ["system", "Variables", "Control Flow"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/process_variable.ts
var node198 = { "name": "Process Variable", "id": "process_variable", "descripition": "Processes a variable with various string, number, and JSON operations", "inputSchema": {
  value: {
    name: "Value",
  ...
  useRegex: {
    name: "Use Regex",
    description: "Treat search value as a regular expression pattern",
    validationSchema: /.*/,
    getVisible: (currentValues) => {
      return currentValues["operation"] === "replace";
    },
  ...
  regexFlags: {
    name: "Regex Flags",
    description: "Regex flags (e.g. g, i, m, gi). Only used when Use Regex is enabled.",
    validationSchema: /^[gimsuy]*$/,
    getVisible: (currentValues) => {
      return currentValues["operation"] === "replace" && (currentValues["useRegex"] === true || currentValues["useRegex"] === "true");
    },
    errorMessage: "Please provide valid regex flags (g, i, m, s, u, y)",
    required: false,
    input: {
      type: "text",
      placeholder: "g",
...
}, "groups": ["system", "Data Processing", "Utilities"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" }, "error": { "id": "error", "name": "Error", "description": "An error occurred during execution" } }, "isTriggerNode": false, "cost": 0 };

// src/store_variable.ts
var node199 = { "name": "Store Variable", "id": "store_variable", "descripition": "Stores a variable for later use", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
    description: "A unique key to identify the variable across different workflow runs. For example, if you use {{phone number}} variable of a lead as the unique key, the variable will be unique per phone number.",
    validationSchema: /.*/,
...
}, "outputSchema": {}, "groups": ["system", "Variables", "Control Flow"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/index.ts
var nodes = { categorise_call: node, get_agent_chat_history: node2, get_agent_chat_history_v2: node3, get_chat_response: node4, get_chat_response_v2: node5, add_to_sms_campaign: node6, get_s_m_s_campaign_messages: node7, make_call: node8, make_call_v2: node9, send_direct_mail: node10, send_email_notification: node11, send_ringless_voicemail: node12, send_s_m_s_notification: node13, send_sms_reply: node14, send_sms_reply_v2: node15, checkcondition: node16, repeat_job: node17, run_another_workflow: node18, split_for_test: node19, waittime: node20, on_outreachgenius_calendar_book_slot_called: node21, on_outreachgenius_calendar_get_available_slots_called: node22, outreachgenius_calendar_book_slot: node23, outreachgenius_calendar_get_available_slots: node24, address_validation_api_get_geo_address: node25, on_address_validation_api_get_geo_address_called: node26, certapro_api_get_events: node27, certapro_api_update_event: node28, on_certapro_api_get_events_called: node29, on_certapro_api_update_event_called: node30, certapro_v2_api_get_events: node31, certapro_v2_api_update_event: node32, on_certapro_v2_api_get_events_called: node33, on_certapro_v2_api_update_event_called: node34, certapro_v3_api_get_events: node35, certapro_v3_api_update_event: node36, on_certapro_v3_api_get_events_called: node37, on_certapro_v3_api_update_event_called: node38, genesys_cloud_api_forward_to_agent: node39, genesys_cloud_api_get_appointment_slots: node40, genesys_cloud_api_submit_lead: node41, on_genesys_cloud_api_forward_to_agent_called: node42, on_genesys_cloud_api_get_appointment_slots_called: node43, on_genesys_cloud_api_submit_lead_called: node44, housecall_v1_api_book_estimate: node45, housecall_v1_api_find_or_create_customer: node46, housecall_v1_api_get_customer: node47, housecall_v1_api_list_available_estimate_slots: node48, housecall_v1_api_search_customers_by_phone: node49, on_housecall_v1_api_book_estimate_called: node50, on_housecall_v1_api_find_or_create_customer_called: node51, on_housecall_v1_api_get_customer_called: node52, on_housecall_v1_api_list_available_estimate_slots_called: node53, on_housecall_v1_api_search_customers_by_phone_called: node54, hubspot_crm_api_book_meeting_slot: node55, hubspot_crm_api_create_contact: node56, hubspot_crm_api_create_note: node57, hubspot_crm_api_get_available_time_slots: node58, hubspot_crm_api_get_contact: node59, hubspot_crm_api_get_meeting_booking_info: node60, hubspot_crm_api_search_contacts: node61, hubspot_crm_api_test_connection: node62, on_hubspot_crm_api_book_meeting_slot_called: node63, on_hubspot_crm_api_create_contact_called: node64, on_hubspot_crm_api_create_note_called: node65, on_hubspot_crm_api_get_available_time_slots_called: node66, on_hubspot_crm_api_get_contact_called: node67, on_hubspot_crm_api_get_meeting_booking_info_called: node68, on_hubspot_crm_api_search_contacts_called: node69, on_hubspot_crm_api_test_connection_called: node70, public_holiday_api_holiday_check_v1: node71, on_public_holiday_api_holiday_check_v1_called: node72, sample_api_sample_tool: node73, on_sample_api_sample_tool_called: node74, sample_api_counter_tool: node75, on_sample_api_counter_tool_called: node76, serviceminder_api_locate_contact: node77, on_serviceminder_api_locate_contact_called: node78, serviceminder_api_add_or_update_contact: node79, on_serviceminder_api_add_or_update_contact_called: node80, serviceminder_api_add_note_to_contact: node81, on_serviceminder_api_add_note_to_contact_called: node82, serviceminder_api_search_available_slots: node83, on_serviceminder_api_search_available_slots_called: node84, serviceminder_api_book_appointment: node85, on_serviceminder_api_book_appointment_called: node86, serviceminder_api_log_call: node87, on_serviceminder_api_log_call_called: node88, psa_api_get_job: node89, on_psa_api_get_job_called: node90, psa_api_get_company: node91, on_psa_api_get_company_called: node92, psa_api_get_contact: node93, on_psa_api_get_contact_called: node94, psa_api_add_company: node95, on_psa_api_add_company_called: node96, psa_api_add_contact: node97, on_psa_api_add_contact_called: node98, psa_api_add_job: node99, on_psa_api_add_job_called: node100, servicetitan_api_get_campaigns: node101, on_servicetitan_api_get_campaigns_called: node102, servicetitan_api_get_business_units: node103, on_servicetitan_api_get_business_units_called: node104, servicetitan_api_get_job_types: node105, on_servicetitan_api_get_job_types_called: node106, servicetitan_api_get_geo_address: node107, on_servicetitan_api_get_geo_address_called: node108, servicetitan_api_get_customer_by_phone: node109, on_servicetitan_api_get_customer_by_phone_called: node110, servicetitan_api_get_customer_locations: node111, on_servicetitan_api_get_customer_locations_called: node112, servicetitan_api_create_customer: node113, on_servicetitan_api_create_customer_called: node114, servicetitan_api_update_customer: node115, on_servicetitan_api_update_customer_called: node116, servicetitan_api_create_customer_location: node117, on_servicetitan_api_create_customer_location_called: node118, servicetitan_api_create_job_for_new_customer: node119, on_servicetitan_api_create_job_for_new_customer_called: node120, servicetitan_api_create_job_for_existing_customer: node121, on_servicetitan_api_create_job_for_existing_customer_called: node122, servicetitan_api_get_jobs_by_customer: node123, on_servicetitan_api_get_jobs_by_customer_called: node124, servicetitan_api_update_job: node125, on_servicetitan_api_update_job_called: node126, servicetitan_api_get_available_technicians: node127, on_servicetitan_api_get_available_technicians_called: node128, servicetitan_api_get_active_technicians: node129, on_servicetitan_api_get_active_technicians_called: node130, servicetitan_api_get_appointments: node131, on_servicetitan_api_get_appointments_called: node132, servicetitan_api_reschedule_appointment: node133, on_servicetitan_api_reschedule_appointment_called: node134, servicetitan_api_update_location_contact: node135, on_servicetitan_api_update_location_contact_called: node136, servicetitan_api_update_customer_contact: node137, on_servicetitan_api_update_customer_contact_called: node138, servicetitan_api_get_cancellation_reasons: node139, on_servicetitan_api_get_cancellation_reasons_called: node140, servicetitan_api_cancel_job: node141, on_servicetitan_api_cancel_job_called: node142, servicetitan_api_update_customer_details: node143, on_servicetitan_api_update_customer_details_called: node144, servicetitan_api_add_call_summary_note: node145, on_servicetitan_api_add_call_summary_note_called: node146, youcanbookme_api_get_available_slots: node147, on_youcanbookme_api_get_available_slots_called: node148, youcanbookme_api_book_slot: node149, on_youcanbookme_api_book_slot_called: node150, on_you_can_book_me_api_book_called: node151, on_you_can_book_me_api_get_events_called: node152, you_can_book_me_api_book: node153, you_can_book_me_api_get_events: node154, add_tag_to_lead: node155, add_tag_to_lead_v2: node156, check_if_invoice_overdue: node157, get_live_staging_leads: node158, get_tags: node159, remove_tag_from_lead: node160, remove_tag_from_lead_v2: node161, add_note_to_lead_service_titan: node162, apply_tag_service_titan: node163, check_job_status_service_titan: node164, get_lead_service_titan: node165, get_service_titan_recurring_service_estimates: node166, get_service_titan_accounts_receievables: node167, get_unassigned_recurring_events: node168, service_titan_technicion_sms: node169, custom_webhook: node170, get_uploaded_leads_trigger: node171, inbound_call_trigger: node172, manual_trigger: node173, on_email_received: node174, on_new_appoinment_service_titan: node175, on_new_call_service_titan: node176, on_new_customer_service_titan: node177, on_new_estimate_service_titan: node178, on_new_invoice_service_titan: node179, on_new_job_or_project_note_service_titan: node180, on_new_job_service_titan: node181, on_new_lead_note_service_titan: node182, on_new_lead_service_titan: node183, on_new_payment_service_titan: node184, on_new_project_service_titan: node185, on_s_m_s_received: node186, on_tag_added: node187, on_updated_call_service_titan: node188, on_updated_estimate_service_titan: node189, on_website_vistor_indentified: node190, run_once_trigger: node191, webhook_trigger: node192, is_public_holiday: node193, extract_common_field: node194, extract_with_a_i: node195, get_constant: node196, get_variable: node197, process_variable: node198, store_variable: node199 };
export {
  nodes
};
