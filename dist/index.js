...
var node77 = { "name": "Remove Tag From Lead", "id": "remove_tag_from_lead", "descripition": "Removes a specified tag from a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
// src/repeat_job.ts
var node78 = { "name": "Repeat Job", "id": "repeat_job", "descripition": "A description for RepeatJob", "inputSchema": {
  repeatType: {
    name: "Repeat Type",
...
var node79 = { "name": "Run Another Workflow", "id": "run_another_workflow", "descripition": "A description for RunAnotherWorkflow", "inputSchema": {
  workflowCode: {
    name: "Workflow Code",
...
var node80 = { "name": "Run Once", "id": "run_once_trigger", "descripition": "A trigger node that runs only once when the workflow is activated", "inputSchema": {}, "outputSchema": {}, "groups": ["Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/sample_api_counter_tool.ts
var node81 = { "name": "Counter Tool", "id": "sample_api_counter_tool", "descripition": "This tool increments a counter stored in the session.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node82 = { "name": "Sample Tool", "id": "sample_api_sample_tool", "descripition": "This is a sample tool within the Sample API.", "inputSchema": {
  param1: {
    name: "param1",
...
var node83 = { "name": "Send Direct Mail", "id": "send_direct_mail", "descripition": "Sends a physical direct mail using a service provider", "inputSchema": {
  productId: {
    name: "Product ID",
...
var node84 = { "name": "Send Email Notification", "id": "send_email_notification", "descripition": "Sends an email message with customizable from, to, cc, bcc fields and SMTP configuration", "inputSchema": {
  useCustomSMTP: {
...
var node85 = { "name": "Send SMS Notification", "id": "send_s_m_s_notification", "descripition": "Sends an SMS message to a specified phone number with customizable content", "inputSchema": {
  to: {
    name: "To",
...
var node86 = { "name": "Send SMS Reply", "id": "send_sms_reply", "descripition": "A description for SendSMSReply", "inputSchema": {
  to: {
    name: "Recipient Number",
...
var node87 = { "name": "Add Note to Contact", "id": "serviceminder_api_add_note_to_contact", "descripition": "Add a note to a customer's record. Useful for call logs and follow-up information.", "inputSchema": {
  noteBody: {
    name: "noteBody",
    description: "Content of the note",
    required: true,
...
var node88 = { "name": "Add or Update Contact", "id": "serviceminder_api_add_or_update_contact", "descripition": "Create a new contact or update existing one. Use when customer information needs to be added or modified.", "inputSchema": {
  campaign: {
    name: "campaign",
...
var node89 = { "name": "Book Appointment", "id": "serviceminder_api_book_appointment", "descripition": "Book a confirmed appointment for a customer. Use after finding available slots.", "inputSchema": {
  quantity: {
    name: "quantity",
...
var node90 = { "name": "Cancel Appointment", "id": "serviceminder_api_cancel_appointment", "descripition": "Cancel an existing appointment with optional reason.", "inputSchema": {
  updateNote: {
    name: "updateNote",
...
var node91 = { "name": "Find Appointments", "id": "serviceminder_api_find_appointments", "descripition": "Search for existing appointments by various criteria.", "inputSchema": {
  includeCompleted: {
...
var node92 = { "name": "Get All Service Agents", "id": "serviceminder_api_get_all_service_agents", "descripition": "Retrieve all service agents/technicians available for appointments.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node93 = { "name": "Get All Services", "id": "serviceminder_api_get_all_services", "descripition": "Retrieve all available services for booking appointments.", "inputSchema": {
  includeParts: {
    name: "includeParts",
...
var node94 = { "name": "Get Cancel Reasons", "id": "serviceminder_api_get_cancel_reasons", "descripition": "Get available cancellation reasons for appointments.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node95 = { "name": "Locate Contact", "id": "serviceminder_api_locate_contact", "descripition": "Search for existing contacts by name, phone, email, or address. Essential for identifying callers.", "inputSchema": {
  limit: {
    name: "limit",
...
var node96 = { "name": "Log Call", "id": "serviceminder_api_log_call", "descripition": "Log details of a phone call interaction.", "inputSchema": {
  callDetails: {
    name: "callDetails",
...
var node97 = { "name": "Query Appointments", "id": "serviceminder_api_query_appointments", "descripition": "Get appointments within a date range, useful for schedule viewing.", "inputSchema": {
  take: {
    name: "take",
    description: "Maximum number of results",
    required: false,
...
var node98 = { "name": "Quick Book Appointment", "id": "serviceminder_api_quick_book_appointment", "descripition": "Quickly book an appointment with customer information and service in one call.", "inputSchema": {
  internalNotes: {
    name: "internalNotes",
...
var node99 = { "name": "Search Available Slots", "id": "serviceminder_api_search_available_slots", "descripition": "Find available appointment slots for scheduling. Essential for booking appointments.", "inputSchema": {
  slotWindowDays: {
    name: "slotWindowDays",
...
var node100 = { "name": "Test Connection", "id": "serviceminder_api_test_connection", "descripition": "Test the API connection and authentication.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node101 = { "name": "Update Appointment", "id": "serviceminder_api_update_appointment", "descripition": "Modify an existing appointment. Use for rescheduling or updating appointment details.", "inputSchema": {
  updateNote: {
    name: "updateNote",
...
var node103 = { "name": "Create Customer", "id": "servicetitan_api_create_customer", "descripition": "Creates a new customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
...
var node104 = { "name": "Create Customer Location", "id": "servicetitan_api_create_customer_location", "descripition": "Creates a new location for a customer in ServiceTitan.", "inputSchema": {
  name: {
    name: "name",
...
var node107 = { "name": "Get Appointments", "id": "servicetitan_api_get_appointments", "descripition": "Retrieves appointments for a specific job.", "inputSchema": {
  jobId: {
    name: "jobId",
    description: "The job ID.",
    required: true,
...
var node108 = { "name": "Get Available Technicians", "id": "servicetitan_api_get_available_technicians", "descripition": "Retrieves both regular available technicians with their free time slots AND the on-call technician for a specific date.", "inputSchema": {
  date: {
    name: "date",
...
var node109 = { "name": "Get Business Units", "id": "servicetitan_api_get_business_units", "descripition": "Retrieves all active business units from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node110 = { "name": "Get Campaigns", "id": "servicetitan_api_get_campaigns", "descripition": "Retrieves all active campaigns from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node111 = { "name": "Get Cancellation Reasons", "id": "servicetitan_api_get_cancellation_reasons", "descripition": "Retrieves all available job cancellation reasons.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node112 = { "name": "Get Customer by Phone", "id": "servicetitan_api_get_customer_by_phone", "descripition": "Retrieves customer information from ServiceTitan by phone number.", "inputSchema": {
  phone: {
    name: "phone",
...
var node113 = { "name": "Get Customer Locations", "id": "servicetitan_api_get_customer_locations", "descripition": "Retrieves location information for a customer from ServiceTitan by customer ID.", "inputSchema": {
  customerId: {
    name: "customerId",
...
var node115 = { "name": "Get Job Types", "id": "servicetitan_api_get_job_types", "descripition": "Retrieves all active job types from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node116 = { "name": "Get Jobs by Customer", "id": "servicetitan_api_get_jobs_by_customer", "descripition": "Retrieves all jobs for a specific customer.", "inputSchema": {
  customerId: {
    name: "customerId",
    description: "The customer ID.",
    required: true,
...
var node117 = { "name": "Reschedule Appointment", "id": "servicetitan_api_reschedule_appointment", "descripition": "Reschedules an existing appointment in ServiceTitan.", "inputSchema": {
  arrivalWindowEnd: {
...
var node118 = { "name": "Update Customer", "id": "servicetitan_api_update_customer", "descripition": "Updates an existing customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
    description: "Array of contact objects (optional).",
    required: false,
...
var node119 = { "name": "Update Customer Contact", "id": "servicetitan_api_update_customer_contact", "descripition": "Updates contact details (email and/or phone) for a customer.", "inputSchema": {
  phone: {
    name: "phone",
...
var node120 = { "name": "Update Customer Details", "id": "servicetitan_api_update_customer_details", "descripition": "Updates comprehensive customer details including name, type, address, and tags.", "inputSchema": {
  tagTypeIds: {
    name: "tagTypeIds",
...
var node121 = { "name": "Update Job", "id": "servicetitan_api_update_job", "descripition": "Updates an existing job in ServiceTitan.", "inputSchema": {
  appointments: {
    name: "appointments",
...
var node122 = { "name": "Update Location Contact", "id": "servicetitan_api_update_location_contact", "descripition": "Updates contact details (email and/or phone) for a location.", "inputSchema": {
  phone: {
    name: "phone",
    description: "New phone number (optional).",
    required: false,
...
var node123 = { "name": "Service Titan Technicion Sms", "id": "service_titan_technicion_sms", "descripition": "This will trigger sending sms and follow up call to the technicion", "inputSchema": {}, "outputSchema": {
  firstPhoneNumber: {
...
var node124 = { "name": "Split For Test", "id": "split_for_test", "descripition": "Split workflow execution between testA and testB branches based on a ratio", "inputSchema": {
  splitRatio: {
...
var node125 = { "name": "Store Variable", "id": "store_variable", "descripition": "Stores a variable for later use", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
    description: "A unique key to identify the variable across different workflow runs. For example, if you use {{phone number}} variable of a lead as the unique key, the variable will be unique per phone number.",
    validationSchema: /.*/,
...
// src/waittime.ts
var node126 = { "name": "Wait Time", "id": "waittime", "descripition": "Pauses the workflow execution for a specified duration before proceeding to the next step", "inputSchema": {
  waitType: {
    name: "Wait Type",
...
var node127 = { "name": "Webhook", "id": "webhook_trigger", "descripition": "Starts a workflow when data is received from an external webhook, extracting contact information", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
