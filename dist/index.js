...
var node31 = { "name": "ServiceTitan Updated Call", "id": "on_updated_call_service_titan", "descripition": "Triggers when a call is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true };

// src/on_updated_estimate_service_titan.ts
var node32 = { "name": "ServiceTitan Updated Estimate", "id": "on_updated_estimate_service_titan", "descripition": "Triggers when an estimate is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true };
...
}, "groups": ["Utilities"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false };
...
}, "outputSchema": {}, "groups": ["Communication", "Direct Mail"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false };
...
}, "groups": ["Advanced", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true };
...
}, "outputSchema": {}, "groups": ["Advanced"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false };
...
}, "groups": ["Lead Generation", "Data Enrichment", "Trigger"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true };

// src/get_service_titan_accounts_receievables.ts
var node45 = { "name": "Get Service Titan Accounts Receievables", "id": "get_service_titan_accounts_receievables", "descripition": "Retrieves accounts receivables from ServiceTitan based on specified filters", "inputSchema": {
  daysPastDue: {
    name: "Days Past Due",
...
}, "groups": ["ServiceTitan"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true };

// src/get_service_titan_recurring_service_estimates.ts
var node46 = { "name": "Get Service Titan Recurring Service Estimates", "id": "get_service_titan_recurring_service_estimates", "descripition": "A description for GetServiceTitanRecurringServiceEstimates", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false };
...
}, "groups": [], "branches": { "overdue": { "id": "overdue", "name": "Overdue", "description": "The invoice is overdue" }, "not_overdue": { "id": "not_overdue", "name": "Not Overdue", "description": "The invoice is not overdue" }, "invoice_not_found": { "id": "invoice_not_found", "name": "Invoice Not Found", "description": "The specified invoice was not found" } }, "isTriggerNode": false };
