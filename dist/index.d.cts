...
declare const nodes: {
    ...
    you_can_book_me_api_get_available_slots: Node;
    on_you_can_book_me_api_get_available_slots_called: Node;
    you_can_book_me_api_book_slot: Node;
    on_you_can_book_me_api_book_slot_called: Node;
