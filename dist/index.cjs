...
var node5 = { "name": "Update Event", "id": "certapro_api_update_event", "descripition": "Books/updates a calendar event with customer information. Takes an event_uid from the available slots and updates it with customer details.", "inputSchema": {
  notes: {
    name: "notes",
...
var node6 = { "name": "Check Condition", "id": "checkcondition", "descripition": "Evaluates a condition comparing values with various operators, including AI-powered question answering", "inputSchema": {
  value: {
    name: "Value",
...
var node7 = { "name": "Check If Invoice Overdue", "id": "check_if_invoice_overdue", "descripition": "A description for CheckIfInvoiceOverdue", "inputSchema": {
  invoiceId: {
    name: "Invoice ID",
...
var node8 = { "name": "Custom Webhook", "id": "custom_webhook", "descripition": "Makes custom HTTP requests to external APIs with configurable methods, headers, and body content", "inputSchema": {
  url: {
    name: "URL",
...
var node9 = { "name": "Extract Common Field", "id": "extract_common_field", "descripition": "Extracts common fields like date, email, or phone number from text using predefined patterns.", "inputSchema": {
  rawText: {
    name: "Raw Text",
...
var node10 = { "name": "Extract With AI", "id": "extract_with_a_i", "descripition": "Extracts specific information from text using AI analysis based on provided instructions", "inputSchema": {
  rawText: {
    name: "Raw Text",
    description: "The text to extract information from",
    validationSchema: /.*/,
...
var node11 = { "name": "Process Chat Response", "id": "get_chat_response", "descripition": "Processes a chat message and sends a reply from the assigned agent using the specified communication channel.", "inputSchema": {
  sessionType: {
    name: "Session Type",
...
// src/get_constant.ts
var node12 = { "name": "Get Constant", "id": "get_constant", "descripition": "Returns various useful constants like time information, system values, and random data", "inputSchema": {
  constantType: {
    name: "Constant Type",
...
var node13 = { "name": "Get Lead Service Titan", "id": "get_lead_service_titan", "descripition": "Get details of a specific lead from ServiceTitan", "inputSchema": {
  customerId: {
    name: "Customer ID",
...
var node14 = { "name": "Get Live Staging Leads", "id": "get_live_staging_leads", "descripition": "A description for GetLiveStagingLeads", "inputSchema": {
  type: {
    name: "Lead Type",
...
var node15 = { "name": "Get SMS Campaign Messages", "id": "get_s_m_s_campaign_messages", "descripition": "Retrieves all messages from a specific SMS campaign by campaign ID", "inputSchema": {
  phone: {
    name: "Phone Number",
...
var node16 = { "name": "Get Service Titan Recurring Service Estimates", "id": "get_service_titan_recurring_service_estimates", "descripition": "A description for GetServiceTitanRecurringServiceEstimates", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_service_titan_accounts_receievables.ts
var node17 = { "name": "Get Service Titan Unpaid Invoices", "id": "get_service_titan_accounts_receievables", "descripition": "Retrieves unpaid invoices from ServiceTitan that are past a specified number of days due.", "inputSchema": {
  daysPastDue: {
    name: "Days Past Due",
...
// src/get_tags.ts
var node18 = { "name": "Get Tags", "id": "get_tags", "descripition": "Retrieves all tags associated with a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
var node19 = { "name": "Get Unassigned Recurring Events", "id": "get_unassigned_recurring_events", "descripition": "A description for GetUnassignedRecurringServiceEvents", "inputSchema": {
  nextNDays: {
    name: "Next N Days",
...
var node20 = { "name": "Get Uploaded Leads Trigger", "id": "get_uploaded_leads_trigger", "descripition": "Triggers a workflow when new leads are uploaded, with options for scheduling and limiting the number of leads", "inputSchema": {
  numLeadsToFetch: {
...
// src/get_variable.ts
var node21 = { "name": "Get Variable", "id": "get_variable", "descripition": "Gets the value of a stored variable", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
...
var node22 = { "name": "Book Estimate", "id": "housecall_v1_api_book_estimate", "descripition": "Create and schedule an estimate with required last name, free estimate line item, bookable employees, and call summary note.", "inputSchema": {
  callSummary: {
    name: "call_summary",
...
var node23 = { "name": "Find Or Create Customer", "id": "housecall_v1_api_find_or_create_customer", "descripition": "Lookup by phone and create if not found (returns the single customer record).", "inputSchema": {
  lastName: {
    name: "last_name",
...
var node24 = { "name": "Get Customer", "id": "housecall_v1_api_get_customer", "descripition": "Retrieve a customer by ID from Housecall.", "inputSchema": {
  id: {
    name: "id",
...
var node25 = { "name": "List Available Estimate Slots", "id": "housecall_v1_api_list_available_estimate_slots", "descripition": "Return available 2-hour EST blocks (10,12,14,16) for the given date with bookable employees.", "inputSchema": {
  date: {
    name: "date",
...
var node26 = { "name": "Search Customers By Phone", "id": "housecall_v1_api_search_customers_by_phone", "descripition": "Find existing customers using a phone number provided during the call.", "inputSchema": {
  phone: {
    name: "phone",
...
var node27 = { "name": "Book Meeting", "id": "hubspot_crm_api_book_meeting", "descripition": "Book a meeting using a scheduling page.", "inputSchema": {
  locale: {
    name: "locale",
...
var node28 = { "name": "Create CRM Meeting", "id": "hubspot_crm_api_create_crm_meeting", "descripition": "Create a meeting engagement in HubSpot CRM (not for scheduling).", "inputSchema": {
  contactIds: {
    name: "contactIds",
...
var node29 = { "name": "Create Contact", "id": "hubspot_crm_api_create_contact", "descripition": "Create a new contact in HubSpot CRM with contact information.", "inputSchema": {
  jobtitle: {
    name: "jobtitle",
...
var node30 = { "name": "Create Meeting", "id": "hubspot_crm_api_create_meeting", "descripition": "Create a new meeting/appointment in HubSpot.", "inputSchema": {
  contactIds: {
    name: "contactIds",
...
var node31 = { "name": "Create Note", "id": "hubspot_crm_api_create_note", "descripition": "Create a note in HubSpot and associate it with contacts.", "inputSchema": {
  contactIds: {
    name: "contactIds",
...
var node32 = { "name": "Get CRM Meeting", "id": "hubspot_crm_api_get_crm_meeting", "descripition": "Retrieve a CRM meeting engagement by ID.", "inputSchema": {
  meetingId: {
    name: "meetingId",
...
var node33 = { "name": "Get Contact", "id": "hubspot_crm_api_get_contact", "descripition": "Retrieve a contact by ID or email from HubSpot.", "inputSchema": {
  email: {
    name: "email",
    description: "Contact's email address",
    required: false,
...
var node34 = { "name": "Get Meeting", "id": "hubspot_crm_api_get_meeting", "descripition": "Retrieve a meeting by ID from HubSpot.", "inputSchema": {
  meetingId: {
    name: "meetingId",
    description: "HubSpot meeting ID",
    required: true,
...
var node35 = { "name": "Get Meeting Availability", "id": "hubspot_crm_api_get_meeting_availability", "descripition": "Get availability page for a meeting link.", "inputSchema": {
  timezone: {
    name: "timezone",
    description: "Timezone",
    required: true,
...
var node36 = { "name": "Get Meeting Booking Info", "id": "hubspot_crm_api_get_meeting_booking_info", "descripition": "Get booking information and availability for a meeting link.", "inputSchema": {
  monthOffset: {
    name: "monthOffset",
...
var node37 = { "name": "Search CRM Meetings", "id": "hubspot_crm_api_search_crm_meetings", "descripition": "Search for CRM meeting engagements by criteria.", "inputSchema": {
  limit: {
    name: "limit",
...
var node38 = { "name": "Search Contacts", "id": "hubspot_crm_api_search_contacts", "descripition": "Search for contacts in HubSpot using various criteria.", "inputSchema": {
  limit: {
    name: "limit",
    description: "Maximum number of results",
    required: false,
...
var node39 = { "name": "Search Meetings", "id": "hubspot_crm_api_search_meetings", "descripition": "Search for meetings in HubSpot by various criteria.", "inputSchema": {
  limit: {
    name: "limit",
    description: "Maximum number of results",
    required: false,
...
var node40 = { "name": "Test Connection", "id": "hubspot_crm_api_test_connection", "descripition": "Test the HubSpot API connection and authentication.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node41 = { "name": "Update CRM Meeting", "id": "hubspot_crm_api_update_crm_meeting", "descripition": "Update an existing CRM meeting engagement.", "inputSchema": {
  location: {
    name: "location",
    description: "Meeting location",
    required: false,
...
var node42 = { "name": "Update Meeting", "id": "hubspot_crm_api_update_meeting", "descripition": "Update an existing meeting in HubSpot.", "inputSchema": {
  location: {
    name: "location",
    description: "Meeting location",
    required: false,
...
var node43 = { "name": "Inbound Call Trigger", "id": "inbound_call_trigger", "descripition": "Triggers a workflow when an inbound call is received, providing caller details and call transcription", "inputSchema": {}, "outputSchema": {
  phone: {
    name: "Phone Number",
...
var node44 = { "name": "Is Public Holiday", "id": "is_public_holiday", "descripition": "Check if current date is a public holiday in the US", "inputSchema": {
  holidays: {
    name: "Holidays",
...
// src/make_call.ts
var node45 = { "name": "Make Call", "id": "make_call", "descripition": "Places an outbound phone call to the specified number with customizable script and voice options", "inputSchema": {
  phone: {
    name: "Phone Number",
...
var node46 = { "name": "Manual Trigger", "id": "manual_trigger", "descripition": "A description for ManualTrigger", "inputSchema": {}, "outputSchema": {
  phone: {
    name: "Phone Number",
...
var node48 = { "name": "ServiceTitan New Appoinment", "id": "on_new_appoinment_service_titan", "descripition": "Triggers when a new appointment is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node49 = { "name": "ServiceTitan New Call", "id": "on_new_call_service_titan", "descripition": "Triggers when a new call is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  createdOn: {
    name: "Created On",
...
var node50 = { "name": "ServiceTitan New Customer", "id": "on_new_customer_service_titan", "descripition": "Triggers when a new customer is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The unique identifier for the customer",
    example: 12345,
...
var node51 = { "name": "ServiceTitan New Estimate", "id": "on_new_estimate_service_titan", "descripition": "Triggers when a new estimate is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node52 = { "name": "ServiceTitan New Invoice", "id": "on_new_invoice_service_titan", "descripition": "Triggers when a new invoice is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node53 = { "name": "ServiceTitan New Job Or Project Note", "id": "on_new_job_or_project_note_service_titan", "descripition": "Triggers when a new note is added to a job or project in ServiceTitan", "inputSchema": {
  entityType: {
    name: "Note Type",
...
var node54 = { "name": "ServiceTitan New Job", "id": "on_new_job_service_titan", "descripition": "Triggers when a new job is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node55 = { "name": "ServiceTitan New Lead Note", "id": "on_new_lead_note_service_titan", "descripition": "Triggers when a new note is added to a lead in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node56 = { "name": "ServiceTitan New Lead", "id": "on_new_lead_service_titan", "descripition": "Triggers when a new lead is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The ID of the lead",
    example: 123,
...
var node57 = { "name": "ServiceTitan New Payment", "id": "on_new_payment_service_titan", "descripition": "Triggers when a new payment is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node58 = { "name": "ServiceTitan New Project", "id": "on_new_project_service_titan", "descripition": "Triggers when a new project is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node59 = { "name": "On SMS Received", "id": "on_s_m_s_received", "descripition": "A description for OnSMSReceived", "inputSchema": {}, "outputSchema": {
  customerNumber: {
...
// src/on_tag_added.ts
var node60 = { "name": "On Tag Added", "id": "on_tag_added", "descripition": "Triggers a workflow when a tag is added to a lead, providing lead information", "inputSchema": {}, "outputSchema": {
  tag: {
    name: "Tag",
...
var node61 = { "name": "ServiceTitan Updated Call", "id": "on_updated_call_service_titan", "descripition": "Triggers when a call is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_updated_estimate_service_titan.ts
var node62 = { "name": "ServiceTitan Updated Estimate", "id": "on_updated_estimate_service_titan", "descripition": "Triggers when an estimate is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_website_vistor_indentified.ts
var node63 = { "name": "On Website Visitor Identified", "id": "on_website_vistor_indentified", "descripition": "Triggers when an anonymous Website visitor is identified via our Pixel Tag", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
...
var node64 = { "name": "Book Slot", "id": "outreachgenius_calendar_book_slot", "descripition": "Book a Cronofy calendar slot for an event", "inputSchema": {
  timezone: {
    name: "timezone",
    description: "Timezone",
    required: false,
...
var node65 = { "name": "Get Available Slots", "id": "outreachgenius_calendar_get_available_slots", "descripition": "Return available Cronofy slots for an eventId (mapped via project/zip if provided)", "inputSchema": {
  timezone: {
    name: "timezone",
    description: "Timezone",
    required: false,
...
var node66 = { "name": "Get Job", "id": "psa_api_get_job", "descripition": "Retrieve job details by ID from PSA system.", "inputSchema": {
  jobId: {
    name: "jobId",
...
var node67 = { "name": "Process Variable", "id": "process_variable", "descripition": "Processes a variable with various string, number, and JSON operations", "inputSchema": {
  value: {
    name: "Value",
...
var node68 = { "name": "Remove Tag From Lead", "id": "remove_tag_from_lead", "descripition": "Removes a specified tag from a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
// src/repeat_job.ts
var node69 = { "name": "Repeat Job", "id": "repeat_job", "descripition": "A description for RepeatJob", "inputSchema": {
  repeatType: {
    name: "Repeat Type",
...
var node70 = { "name": "Run Another Workflow", "id": "run_another_workflow", "descripition": "A description for RunAnotherWorkflow", "inputSchema": {
  workflowCode: {
    name: "Workflow Code",
...
var node71 = { "name": "Run Once", "id": "run_once_trigger", "descripition": "A trigger node that runs only once when the workflow is activated", "inputSchema": {}, "outputSchema": {}, "groups": ["Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/sample_api_counter_tool.ts
var node72 = { "name": "Counter Tool", "id": "sample_api_counter_tool", "descripition": "This tool increments a counter stored in the session.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node74 = { "name": "Send Direct Mail", "id": "send_direct_mail", "descripition": "Sends a physical direct mail using a service provider", "inputSchema": {
  productId: {
    name: "Product ID",
...
var node75 = { "name": "Send Email Notification", "id": "send_email_notification", "descripition": "Sends an email message with customizable from, to, cc, bcc fields and SMTP configuration", "inputSchema": {
  useCustomSMTP: {
...
var node76 = { "name": "Send SMS Notification", "id": "send_s_m_s_notification", "descripition": "Sends an SMS message to a specified phone number with customizable content", "inputSchema": {
  to: {
    name: "To",
...
var node77 = { "name": "Send SMS Reply", "id": "send_sms_reply", "descripition": "A description for SendSMSReply", "inputSchema": {
  to: {
    name: "Recipient Number",
...
var node78 = { "name": "Add Note to Contact", "id": "serviceminder_api_add_note_to_contact", "descripition": "Add a note to a customer's record. Useful for call logs and follow-up information.", "inputSchema": {
  noteBody: {
    name: "noteBody",
    description: "Content of the note",
    required: true,
...
var node80 = { "name": "Book Appointment", "id": "serviceminder_api_book_appointment", "descripition": "Book a confirmed appointment for a customer. Use after finding available slots.", "inputSchema": {
  quantity: {
    name: "quantity",
...
var node81 = { "name": "Cancel Appointment", "id": "serviceminder_api_cancel_appointment", "descripition": "Cancel an existing appointment with optional reason.", "inputSchema": {
  updateNote: {
    name: "updateNote",
...
var node82 = { "name": "Find Appointments", "id": "serviceminder_api_find_appointments", "descripition": "Search for existing appointments by various criteria.", "inputSchema": {
  includeCompleted: {
...
var node83 = { "name": "Get All Service Agents", "id": "serviceminder_api_get_all_service_agents", "descripition": "Retrieve all service agents/technicians available for appointments.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node84 = { "name": "Get All Services", "id": "serviceminder_api_get_all_services", "descripition": "Retrieve all available services for booking appointments.", "inputSchema": {
  includeParts: {
    name: "includeParts",
...
var node85 = { "name": "Get Cancel Reasons", "id": "serviceminder_api_get_cancel_reasons", "descripition": "Get available cancellation reasons for appointments.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node86 = { "name": "Locate Contact", "id": "serviceminder_api_locate_contact", "descripition": "Search for existing contacts by name, phone, email, or address. Essential for identifying callers.", "inputSchema": {
  limit: {
    name: "limit",
...
var node88 = { "name": "Query Appointments", "id": "serviceminder_api_query_appointments", "descripition": "Get appointments within a date range, useful for schedule viewing.", "inputSchema": {
  take: {
    name: "take",
    description: "Maximum number of results",
    required: false,
...
var node89 = { "name": "Quick Book Appointment", "id": "serviceminder_api_quick_book_appointment", "descripition": "Quickly book an appointment with customer information and service in one call.", "inputSchema": {
  internalNotes: {
    name: "internalNotes",
...
var node90 = { "name": "Search Available Slots", "id": "serviceminder_api_search_available_slots", "descripition": "Find available appointment slots for scheduling. Essential for booking appointments.", "inputSchema": {
  slotWindowDays: {
    name: "slotWindowDays",
...
var node91 = { "name": "Test Connection", "id": "serviceminder_api_test_connection", "descripition": "Test the API connection and authentication.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node92 = { "name": "Update Appointment", "id": "serviceminder_api_update_appointment", "descripition": "Modify an existing appointment. Use for rescheduling or updating appointment details.", "inputSchema": {
  updateNote: {
    name: "updateNote",
...
var node93 = { "name": "Cancel Job", "id": "servicetitan_api_cancel_job", "descripition": "Cancels a job in ServiceTitan.", "inputSchema": {
  memo: {
    name: "memo",
...
var node94 = { "name": "Create Customer", "id": "servicetitan_api_create_customer", "descripition": "Creates a new customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
...
var node95 = { "name": "Create Customer Location", "id": "servicetitan_api_create_customer_location", "descripition": "Creates a new location for a customer in ServiceTitan.", "inputSchema": {
  name: {
    name: "name",
...
var node98 = { "name": "Get Appointments", "id": "servicetitan_api_get_appointments", "descripition": "Retrieves appointments for a specific job.", "inputSchema": {
  jobId: {
    name: "jobId",
    description: "The job ID.",
    required: true,
...
var node99 = { "name": "Get Available Technicians", "id": "servicetitan_api_get_available_technicians", "descripition": "Retrieves both regular available technicians with their free time slots AND the on-call technician for a specific date.", "inputSchema": {
  date: {
    name: "date",
...
var node100 = { "name": "Get Business Units", "id": "servicetitan_api_get_business_units", "descripition": "Retrieves all active business units from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node102 = { "name": "Get Cancellation Reasons", "id": "servicetitan_api_get_cancellation_reasons", "descripition": "Retrieves all available job cancellation reasons.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node103 = { "name": "Get Customer by Phone", "id": "servicetitan_api_get_customer_by_phone", "descripition": "Retrieves customer information from ServiceTitan by phone number.", "inputSchema": {
  phone: {
    name: "phone",
...
var node104 = { "name": "Get Customer Locations", "id": "servicetitan_api_get_customer_locations", "descripition": "Retrieves location information for a customer from ServiceTitan by customer ID.", "inputSchema": {
  customerId: {
    name: "customerId",
...
var node106 = { "name": "Get Job Types", "id": "servicetitan_api_get_job_types", "descripition": "Retrieves all active job types from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node107 = { "name": "Get Jobs by Customer", "id": "servicetitan_api_get_jobs_by_customer", "descripition": "Retrieves all jobs for a specific customer.", "inputSchema": {
  customerId: {
    name: "customerId",
    description: "The customer ID.",
    required: true,
...
var node108 = { "name": "Reschedule Appointment", "id": "servicetitan_api_reschedule_appointment", "descripition": "Reschedules an existing appointment in ServiceTitan.", "inputSchema": {
  arrivalWindowEnd: {
...
var node109 = { "name": "Update Customer", "id": "servicetitan_api_update_customer", "descripition": "Updates an existing customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
    description: "Array of contact objects (optional).",
    required: false,
...
var node110 = { "name": "Update Customer Contact", "id": "servicetitan_api_update_customer_contact", "descripition": "Updates contact details (email and/or phone) for a customer.", "inputSchema": {
  phone: {
    name: "phone",
...
var node111 = { "name": "Update Customer Details", "id": "servicetitan_api_update_customer_details", "descripition": "Updates comprehensive customer details including name, type, address, and tags.", "inputSchema": {
  tagTypeIds: {
    name: "tagTypeIds",
...
var node112 = { "name": "Update Job", "id": "servicetitan_api_update_job", "descripition": "Updates an existing job in ServiceTitan.", "inputSchema": {
  appointments: {
    name: "appointments",
...
var node113 = { "name": "Update Location Contact", "id": "servicetitan_api_update_location_contact", "descripition": "Updates contact details (email and/or phone) for a location.", "inputSchema": {
  phone: {
    name: "phone",
    description: "New phone number (optional).",
    required: false,
...
var node114 = { "name": "Service Titan Technicion Sms", "id": "service_titan_technicion_sms", "descripition": "This will trigger sending sms and follow up call to the technicion", "inputSchema": {}, "outputSchema": {
  firstPhoneNumber: {
...
var node115 = { "name": "Split For Test", "id": "split_for_test", "descripition": "Split workflow execution between testA and testB branches based on a ratio", "inputSchema": {
  splitRatio: {
...
var node116 = { "name": "Store Variable", "id": "store_variable", "descripition": "Stores a variable for later use", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
    description: "A unique key to identify the variable across different workflow runs. For example, if you use {{phone number}} variable of a lead as the unique key, the variable will be unique per phone number.",
    validationSchema: /.*/,
...
// src/waittime.ts
var node117 = { "name": "Wait Time", "id": "waittime", "descripition": "Pauses the workflow execution for a specified duration before proceeding to the next step", "inputSchema": {
  waitType: {
    name: "Wait Type",
...
var node118 = { "name": "Webhook", "id": "webhook_trigger", "descripition": "Starts a workflow when data is received from an external webhook, extracting contact information", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
...
// src/index.ts
var nodes = { add_note_to_lead_service_titan: node, add_tag_to_lead: node2, add_to_sms_campaign: node3, apply_tag_service_titan: node4, certapro_api_update_event: node5, checkcondition: node6, check_if_invoice_overdue: node7, custom_webhook: node8, extract_common_field: node9, extract_with_a_i: node10, get_chat_response: node11, get_constant: node12, get_lead_service_titan: node13, get_live_staging_leads: node14, get_s_m_s_campaign_messages: node15, get_service_titan_recurring_service_estimates: node16, get_service_titan_accounts_receievables: node17, get_tags: node18, get_unassigned_recurring_events: node19, get_uploaded_leads_trigger: node20, get_variable: node21, housecall_v1_api_book_estimate: node22, housecall_v1_api_find_or_create_customer: node23, housecall_v1_api_get_customer: node24, housecall_v1_api_list_available_estimate_slots: node25, housecall_v1_api_search_customers_by_phone: node26, hubspot_crm_api_book_meeting: node27, hubspot_crm_api_create_crm_meeting: node28, hubspot_crm_api_create_contact: node29, hubspot_crm_api_create_meeting: node30, hubspot_crm_api_create_note: node31, hubspot_crm_api_get_crm_meeting: node32, hubspot_crm_api_get_contact: node33, hubspot_crm_api_get_meeting: node34, hubspot_crm_api_get_meeting_availability: node35, hubspot_crm_api_get_meeting_booking_info: node36, hubspot_crm_api_search_crm_meetings: node37, hubspot_crm_api_search_contacts: node38, hubspot_crm_api_search_meetings: node39, hubspot_crm_api_test_connection: node40, hubspot_crm_api_update_crm_meeting: node41, hubspot_crm_api_update_meeting: node42, inbound_call_trigger: node43, is_public_holiday: node44, make_call: node45, manual_trigger: node46, on_email_received: node47, on_new_appoinment_service_titan: node48, on_new_call_service_titan: node49, on_new_customer_service_titan: node50, on_new_estimate_service_titan: node51, on_new_invoice_service_titan: node52, on_new_job_or_project_note_service_titan: node53, on_new_job_service_titan: node54, on_new_lead_note_service_titan: node55, on_new_lead_service_titan: node56, on_new_payment_service_titan: node57, on_new_project_service_titan: node58, on_s_m_s_received: node59, on_tag_added: node60, on_updated_call_service_titan: node61, on_updated_estimate_service_titan: node62, on_website_vistor_indentified: node63, outreachgenius_calendar_book_slot: node64, outreachgenius_calendar_get_available_slots: node65, psa_api_get_job: node66, process_variable: node67, remove_tag_from_lead: node68, repeat_job: node69, run_another_workflow: node70, run_once_trigger: node71, sample_api_counter_tool: node72, sample_api_sample_tool: node73, send_direct_mail: node74, send_email_notification: node75, send_s_m_s_notification: node76, send_sms_reply: node77, serviceminder_api_add_note_to_contact: node78, serviceminder_api_add_or_update_contact: node79, serviceminder_api_book_appointment: node80, serviceminder_api_cancel_appointment: node81, serviceminder_api_find_appointments: node82, serviceminder_api_get_all_service_agents: node83, serviceminder_api_get_all_services: node84, serviceminder_api_get_cancel_reasons: node85, serviceminder_api_locate_contact: node86, serviceminder_api_log_call: node87, serviceminder_api_query_appointments: node88, serviceminder_api_quick_book_appointment: node89, serviceminder_api_search_available_slots: node90, serviceminder_api_test_connection: node91, serviceminder_api_update_appointment: node92, servicetitan_api_cancel_job: node93, servicetitan_api_create_customer: node94, servicetitan_api_create_customer_location: node95, servicetitan_api_create_job_for_existing_customer: node96, servicetitan_api_create_job_for_new_customer: node97, servicetitan_api_get_appointments: node98, servicetitan_api_get_available_technicians: node99, servicetitan_api_get_business_units: node100, servicetitan_api_get_campaigns: node101, servicetitan_api_get_cancellation_reasons: node102, servicetitan_api_get_customer_by_phone: node103, servicetitan_api_get_customer_locations: node104, servicetitan_api_get_geo_address: node105, servicetitan_api_get_job_types: node106, servicetitan_api_get_jobs_by_customer: node107, servicetitan_api_reschedule_appointment: node108, servicetitan_api_update_customer: node109, servicetitan_api_update_customer_contact: node110, servicetitan_api_update_customer_details: node111, servicetitan_api_update_job: node112, servicetitan_api_update_location_contact: node113, service_titan_technicion_sms: node114, split_for_test: node115, store_variable: node116, waittime: node117, webhook_trigger: node118 };
