...
var node5 = { "name": "Check Condition", "id": "checkcondition", "descripition": "Evaluates a condition comparing values with various operators, including AI-powered question answering", "inputSchema": {
  value: {
    name: "Value",
...
var node6 = { "name": "Check If Invoice Overdue", "id": "check_if_invoice_overdue", "descripition": "A description for CheckIfInvoiceOverdue", "inputSchema": {
  invoiceId: {
    name: "Invoice ID",
...
var node7 = { "name": "Custom Webhook", "id": "custom_webhook", "descripition": "Makes custom HTTP requests to external APIs with configurable methods, headers, and body content", "inputSchema": {
  url: {
    name: "URL",
...
var node8 = { "name": "Extract Common Field", "id": "extract_common_field", "descripition": "Extracts common fields like date, email, or phone number from text using predefined patterns.", "inputSchema": {
  rawText: {
    name: "Raw Text",
...
var node9 = { "name": "Extract With AI", "id": "extract_with_a_i", "descripition": "Extracts specific information from text using AI analysis based on provided instructions", "inputSchema": {
  rawText: {
    name: "Raw Text",
    description: "The text to extract information from",
    validationSchema: /.*/,
...
// src/get_constant.ts
var node10 = { "name": "Get Constant", "id": "get_constant", "descripition": "Returns various useful constants like time information, system values, and random data", "inputSchema": {
  constantType: {
    name: "Constant Type",
...
var node11 = { "name": "Get Lead Service Titan", "id": "get_lead_service_titan", "descripition": "Get details of a specific lead from ServiceTitan", "inputSchema": {
  customerId: {
    name: "Customer ID",
...
var node12 = { "name": "Get Live Staging Leads", "id": "get_live_staging_leads", "descripition": "A description for GetLiveStagingLeads", "inputSchema": {
  type: {
    name: "Lead Type",
...
var node13 = { "name": "Get SMS Campaign Messages", "id": "get_s_m_s_campaign_messages", "descripition": "Retrieves all messages from a specific SMS campaign by campaign ID", "inputSchema": {
  phone: {
    name: "Phone Number",
...
var node14 = { "name": "Get Service Titan Recurring Service Estimates", "id": "get_service_titan_recurring_service_estimates", "descripition": "A description for GetServiceTitanRecurringServiceEstimates", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": false, "cost": 0 };

// src/get_service_titan_accounts_receievables.ts
var node15 = { "name": "Get Service Titan Unpaid Invoices", "id": "get_service_titan_accounts_receievables", "descripition": "Retrieves unpaid invoices from ServiceTitan that are past a specified number of days due.", "inputSchema": {
  daysPastDue: {
    name: "Days Past Due",
...
// src/get_tags.ts
var node16 = { "name": "Get Tags", "id": "get_tags", "descripition": "Retrieves all tags associated with a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
var node17 = { "name": "Get Unassigned Recurring Events", "id": "get_unassigned_recurring_events", "descripition": "A description for GetUnassignedRecurringServiceEvents", "inputSchema": {
  nextNDays: {
    name: "Next N Days",
...
var node18 = { "name": "Get Uploaded Leads Trigger", "id": "get_uploaded_leads_trigger", "descripition": "Triggers a workflow when new leads are uploaded, with options for scheduling and limiting the number of leads", "inputSchema": {
  numLeadsToFetch: {
...
// src/get_variable.ts
var node19 = { "name": "Get Variable", "id": "get_variable", "descripition": "Gets the value of a stored variable", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
...
var node20 = { "name": "Book Estimate", "id": "housecall_v1_api_book_estimate", "descripition": "Create and schedule an estimate with required last name, free estimate line item, bookable employees, and call summary note.", "inputSchema": {
  callSummary: {
    name: "call_summary",
...
var node21 = { "name": "Find Or Create Customer", "id": "housecall_v1_api_find_or_create_customer", "descripition": "Lookup by phone and create if not found (returns the single customer record).", "inputSchema": {
  lastName: {
    name: "last_name",
...
var node22 = { "name": "Get Customer", "id": "housecall_v1_api_get_customer", "descripition": "Retrieve a customer by ID from Housecall.", "inputSchema": {
  id: {
    name: "id",
...
var node23 = { "name": "List Available Estimate Slots", "id": "housecall_v1_api_list_available_estimate_slots", "descripition": "Return available 2-hour EST blocks (10,12,14,16) for the given date with bookable employees.", "inputSchema": {
  date: {
    name: "date",
...
var node24 = { "name": "Search Customers By Phone", "id": "housecall_v1_api_search_customers_by_phone", "descripition": "Find existing customers using a phone number provided during the call.", "inputSchema": {
  phone: {
    name: "phone",
...
var node25 = { "name": "Inbound Call Trigger", "id": "inbound_call_trigger", "descripition": "Triggers a workflow when an inbound call is received, providing caller details and call transcription", "inputSchema": {}, "outputSchema": {
  phone: {
    name: "Phone Number",
...
// src/make_call.ts
var node26 = { "name": "Make Call", "id": "make_call", "descripition": "Places an outbound phone call to the specified number with customizable script and voice options", "inputSchema": {
  phone: {
    name: "Phone Number",
...
var node27 = { "name": "Manual Trigger", "id": "manual_trigger", "descripition": "A description for ManualTrigger", "inputSchema": {}, "outputSchema": {
  phone: {
    name: "Phone Number",
...
var node29 = { "name": "ServiceTitan New Appoinment", "id": "on_new_appoinment_service_titan", "descripition": "Triggers when a new appointment is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node31 = { "name": "ServiceTitan New Customer", "id": "on_new_customer_service_titan", "descripition": "Triggers when a new customer is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The unique identifier for the customer",
    example: 12345,
...
var node32 = { "name": "ServiceTitan New Estimate", "id": "on_new_estimate_service_titan", "descripition": "Triggers when a new estimate is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node33 = { "name": "ServiceTitan New Invoice", "id": "on_new_invoice_service_titan", "descripition": "Triggers when a new invoice is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node34 = { "name": "ServiceTitan New Job Or Project Note", "id": "on_new_job_or_project_note_service_titan", "descripition": "Triggers when a new note is added to a job or project in ServiceTitan", "inputSchema": {
  entityType: {
    name: "Note Type",
...
var node35 = { "name": "ServiceTitan New Job", "id": "on_new_job_service_titan", "descripition": "Triggers when a new job is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node36 = { "name": "ServiceTitan New Lead Note", "id": "on_new_lead_note_service_titan", "descripition": "Triggers when a new note is added to a lead in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node37 = { "name": "ServiceTitan New Lead", "id": "on_new_lead_service_titan", "descripition": "Triggers when a new lead is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
    description: "The ID of the lead",
    example: 123,
...
var node38 = { "name": "ServiceTitan New Payment", "id": "on_new_payment_service_titan", "descripition": "Triggers when a new payment is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
var node39 = { "name": "ServiceTitan New Project", "id": "on_new_project_service_titan", "descripition": "Triggers when a new project is created in ServiceTitan", "inputSchema": {}, "outputSchema": {
  id: {
    name: "ID",
...
// src/on_tag_added.ts
var node40 = { "name": "On Tag Added", "id": "on_tag_added", "descripition": "Triggers a workflow when a tag is added to a lead, providing lead information", "inputSchema": {}, "outputSchema": {
  tag: {
    name: "Tag",
...
var node41 = { "name": "ServiceTitan Updated Call", "id": "on_updated_call_service_titan", "descripition": "Triggers when a call is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_updated_estimate_service_titan.ts
var node42 = { "name": "ServiceTitan Updated Estimate", "id": "on_updated_estimate_service_titan", "descripition": "Triggers when an estimate is updated in ServiceTitan", "inputSchema": {}, "outputSchema": {}, "groups": ["ServiceTitan", "Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/on_website_vistor_indentified.ts
var node43 = { "name": "On Website Visitor Identified", "id": "on_website_vistor_indentified", "descripition": "Triggers when an anonymous Website visitor is identified via our Pixel Tag", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
...
var node44 = { "name": "Process Variable", "id": "process_variable", "descripition": "Processes a variable with various string, number, and JSON operations", "inputSchema": {
  value: {
    name: "Value",
...
var node45 = { "name": "Remove Tag From Lead", "id": "remove_tag_from_lead", "descripition": "Removes a specified tag from a lead identified by email or phone number", "inputSchema": {
  email: {
    name: "Email",
    description: "Email address of the lead",
    validationSchema: /^[^\s@]+@[^\s@]+\.[^\s@]+$/,
...
// src/repeat_job.ts
var node46 = { "name": "Repeat Job", "id": "repeat_job", "descripition": "A description for RepeatJob", "inputSchema": {
  repeatType: {
    name: "Repeat Type",
...
var node47 = { "name": "Run Another Workflow", "id": "run_another_workflow", "descripition": "A description for RunAnotherWorkflow", "inputSchema": {
  workflowCode: {
    name: "Workflow Code",
...
var node48 = { "name": "Run Once", "id": "run_once_trigger", "descripition": "A trigger node that runs only once when the workflow is activated", "inputSchema": {}, "outputSchema": {}, "groups": ["Triggers"], "branches": { "success": { "id": "success", "name": "Success", "description": "Successful execution" } }, "isTriggerNode": true, "cost": 0 };

// src/sample_api_counter_tool.ts
var node49 = { "name": "Counter Tool", "id": "sample_api_counter_tool", "descripition": "This tool increments a counter stored in the session.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node50 = { "name": "Sample Tool", "id": "sample_api_sample_tool", "descripition": "This is a sample tool within the Sample API.", "inputSchema": {
  param1: {
    name: "param1",
...
var node51 = { "name": "Send Direct Mail", "id": "send_direct_mail", "descripition": "Sends a physical direct mail using a service provider", "inputSchema": {
  productId: {
    name: "Product ID",
...
var node52 = { "name": "Send Email Notification", "id": "send_email_notification", "descripition": "Sends an email message with customizable from, to, cc, bcc fields and SMTP configuration", "inputSchema": {
  useCustomSMTP: {
...
var node53 = { "name": "Send SMS Notification", "id": "send_s_m_s_notification", "descripition": "Sends an SMS message to a specified phone number with customizable content", "inputSchema": {
  to: {
    name: "To",
...
var node54 = { "name": "Cancel Job", "id": "servicetitan_api_cancel_job", "descripition": "Cancels a job in ServiceTitan.", "inputSchema": {
  memo: {
    name: "memo",
...
var node55 = { "name": "Create Customer", "id": "servicetitan_api_create_customer", "descripition": "Creates a new customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
...
var node56 = { "name": "Create Customer Location", "id": "servicetitan_api_create_customer_location", "descripition": "Creates a new location for a customer in ServiceTitan.", "inputSchema": {
  name: {
    name: "name",
...
var node59 = { "name": "Get Appointments", "id": "servicetitan_api_get_appointments", "descripition": "Retrieves appointments for a specific job.", "inputSchema": {
  jobId: {
    name: "jobId",
    description: "The job ID.",
    required: true,
...
var node60 = { "name": "Get Available Technicians", "id": "servicetitan_api_get_available_technicians", "descripition": "Retrieves both regular available technicians with their free time slots AND the on-call technician for a specific date.", "inputSchema": {
  date: {
    name: "date",
...
var node62 = { "name": "Get Campaigns", "id": "servicetitan_api_get_campaigns", "descripition": "Retrieves all active campaigns from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node63 = { "name": "Get Cancellation Reasons", "id": "servicetitan_api_get_cancellation_reasons", "descripition": "Retrieves all available job cancellation reasons.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node67 = { "name": "Get Job Types", "id": "servicetitan_api_get_job_types", "descripition": "Retrieves all active job types from ServiceTitan.", "inputSchema": {
  // no params
}, "outputSchema": {
  result: {
    name: "Result",
...
var node68 = { "name": "Get Jobs by Customer", "id": "servicetitan_api_get_jobs_by_customer", "descripition": "Retrieves all jobs for a specific customer.", "inputSchema": {
  customerId: {
    name: "customerId",
    description: "The customer ID.",
    required: true,
...
var node69 = { "name": "Reschedule Appointment", "id": "servicetitan_api_reschedule_appointment", "descripition": "Reschedules an existing appointment in ServiceTitan.", "inputSchema": {
  arrivalWindowEnd: {
...
var node70 = { "name": "Update Customer", "id": "servicetitan_api_update_customer", "descripition": "Updates an existing customer in ServiceTitan.", "inputSchema": {
  contacts: {
    name: "contacts",
    description: "Array of contact objects (optional).",
    required: false,
...
var node71 = { "name": "Update Customer Contact", "id": "servicetitan_api_update_customer_contact", "descripition": "Updates contact details (email and/or phone) for a customer.", "inputSchema": {
  phone: {
    name: "phone",
...
var node72 = { "name": "Update Customer Details", "id": "servicetitan_api_update_customer_details", "descripition": "Updates comprehensive customer details including name, type, address, and tags.", "inputSchema": {
  tagTypeIds: {
    name: "tagTypeIds",
...
var node73 = { "name": "Update Job", "id": "servicetitan_api_update_job", "descripition": "Updates an existing job in ServiceTitan.", "inputSchema": {
  appointments: {
    name: "appointments",
...
var node74 = { "name": "Update Location Contact", "id": "servicetitan_api_update_location_contact", "descripition": "Updates contact details (email and/or phone) for a location.", "inputSchema": {
  phone: {
    name: "phone",
    description: "New phone number (optional).",
    required: false,
...
var node75 = { "name": "Service Titan Technicion Sms", "id": "service_titan_technicion_sms", "descripition": "This will trigger sending sms and follow up call to the technicion", "inputSchema": {}, "outputSchema": {
  firstPhoneNumber: {
...
var node76 = { "name": "Split For Test", "id": "split_for_test", "descripition": "Split workflow execution between testA and testB branches based on a ratio", "inputSchema": {
  splitRatio: {
...
var node77 = { "name": "Store Variable", "id": "store_variable", "descripition": "Stores a variable for later use", "inputSchema": {
  uniqueKey: {
    name: "Unique Key",
    description: "A unique key to identify the variable across different workflow runs. For example, if you use {{phone number}} variable of a lead as the unique key, the variable will be unique per phone number.",
    validationSchema: /.*/,
...
// src/waittime.ts
var node78 = { "name": "Wait Time", "id": "waittime", "descripition": "Pauses the workflow execution for a specified duration before proceeding to the next step", "inputSchema": {
  waitType: {
    name: "Wait Type",
...
var node79 = { "name": "Webhook", "id": "webhook_trigger", "descripition": "Starts a workflow when data is received from an external webhook, extracting contact information", "inputSchema": {}, "outputSchema": {
  firstName: {
    name: "First Name",
    description: "The first name of the person",
    example: "John",
...
// src/index.ts
var nodes = { add_note_to_lead_service_titan: node, add_tag_to_lead: node2, add_to_sms_campaign: node3, apply_tag_service_titan: node4, checkcondition: node5, check_if_invoice_overdue: node6, custom_webhook: node7, extract_common_field: node8, extract_with_a_i: node9, get_constant: node10, get_lead_service_titan: node11, get_live_staging_leads: node12, get_s_m_s_campaign_messages: node13, get_service_titan_recurring_service_estimates: node14, get_service_titan_accounts_receievables: node15, get_tags: node16, get_unassigned_recurring_events: node17, get_uploaded_leads_trigger: node18, get_variable: node19, housecall_v1_api_book_estimate: node20, housecall_v1_api_find_or_create_customer: node21, housecall_v1_api_get_customer: node22, housecall_v1_api_list_available_estimate_slots: node23, housecall_v1_api_search_customers_by_phone: node24, inbound_call_trigger: node25, make_call: node26, manual_trigger: node27, on_email_received: node28, on_new_appoinment_service_titan: node29, on_new_call_service_titan: node30, on_new_customer_service_titan: node31, on_new_estimate_service_titan: node32, on_new_invoice_service_titan: node33, on_new_job_or_project_note_service_titan: node34, on_new_job_service_titan: node35, on_new_lead_note_service_titan: node36, on_new_lead_service_titan: node37, on_new_payment_service_titan: node38, on_new_project_service_titan: node39, on_tag_added: node40, on_updated_call_service_titan: node41, on_updated_estimate_service_titan: node42, on_website_vistor_indentified: node43, process_variable: node44, remove_tag_from_lead: node45, repeat_job: node46, run_another_workflow: node47, run_once_trigger: node48, sample_api_counter_tool: node49, sample_api_sample_tool: node50, send_direct_mail: node51, send_email_notification: node52, send_s_m_s_notification: node53, servicetitan_api_cancel_job: node54, servicetitan_api_create_customer: node55, servicetitan_api_create_customer_location: node56, servicetitan_api_create_job_for_existing_customer: node57, servicetitan_api_create_job_for_new_customer: node58, servicetitan_api_get_appointments: node59, servicetitan_api_get_available_technicians: node60, servicetitan_api_get_business_units: node61, servicetitan_api_get_campaigns: node62, servicetitan_api_get_cancellation_reasons: node63, servicetitan_api_get_customer_by_phone: node64, servicetitan_api_get_customer_locations: node65, servicetitan_api_get_geo_address: node66, servicetitan_api_get_job_types: node67, servicetitan_api_get_jobs_by_customer: node68, servicetitan_api_reschedule_appointment: node69, servicetitan_api_update_customer: node70, servicetitan_api_update_customer_contact: node71, servicetitan_api_update_customer_details: node72, servicetitan_api_update_job: node73, servicetitan_api_update_location_contact: node74, service_titan_technicion_sms: node75, split_for_test: node76, store_variable: node77, waittime: node78, webhook_trigger: node79 };
